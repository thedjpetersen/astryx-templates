...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Teen Therapy Guardian Consent. No Date.now(),
 ...
 * @output Teen Therapy Guardian Consent: Therapy website experience for a teen therapy consent and privacy experience, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for guardians and teens understanding consent, privacy, and care boundaries. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template teen-therapy-guardian-consent`
 *
...
const SCOPE = "tpl-teen-therapy-guardian-consent";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Specialty Care",
  title: "Teen Therapy Guardian Consent",
  focus: "a teen therapy consent and privacy experience",
  audience: "guardians and teens understanding consent, privacy, and care boundaries",
  primary: "Review consent",
  secondary: "Invite guardian",
  metric: "2 step",
  metricLabel: "consent flow",
  metricCaption: "Teen privacy expectations and guardian requirements are written plainly.",
  searchPlaceholder: "Search teen care, guardian, or privacy",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what guardians and teens understanding consent, privacy, and care boundaries need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Review consent",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a teen therapy consent and privacy experience.",
    "metric": "2 step",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after review consent, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "teen care",
    "detail": "Visitors can understand a teen therapy consent and privacy experience without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "guardian",
  ...
  },
  {
    "label": "Begin care",
    "value": "2 step",
    "detail": "Teen privacy expectations and guardian requirements are written plainly."
  }
];
const RESOURCES = [
...
export default function TeenTherapyGuardianConsent() {
