...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Therapist Match Results. No Date.now(),
 ...
 * @output Therapist Match Results: Therapy website experience for a personalized therapist match results page, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients reviewing recommended therapists after a guided quiz. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template therapist-match-results`
 *
...
const SCOPE = "tpl-therapist-match-results";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Discovery",
  title: "Therapist Match Results",
  focus: "a personalized therapist match results page",
  audience: "clients reviewing recommended therapists after a guided quiz",
  primary: "Compare matches",
  secondary: "Refine answers",
  metric: "5",
  metricLabel: "strong matches",
  metricCaption: "Match reasons explain specialty, style, availability, and insurance fit.",
  searchPlaceholder: "Search fit score, licensed, or next opening",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients reviewing recommended therapists after a guided quiz need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Compare matches",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a personalized therapist match results page.",
    "metric": "5",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after compare matches, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "fit score",
    "detail": "Visitors can understand a personalized therapist match results page without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "licensed",
  ...
  },
  {
    "label": "Begin care",
    "value": "5",
    "detail": "Match reasons explain specialty, style, availability, and insurance fit."
  }
];
const RESOURCES = [
  "Discovery guide",
...
export default function TherapistMatchResults() {
