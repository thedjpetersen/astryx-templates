...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Postpartum Therapy Program. No Date.now(),
 ...
 * @output Postpartum Therapy Program: Therapy website experience for a postpartum therapy program page, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for new parents seeking support for mood, identity, and adjustment. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template postpartum-therapy-program`
 *
...
const SCOPE = "tpl-postpartum-therapy-program";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Program",
  title: "Postpartum Therapy Program",
  focus: "a postpartum therapy program page",
  audience: "new parents seeking support for mood, identity, and adjustment",
  primary: "Start support",
  secondary: "See program",
  metric: "4 wk",
  metricLabel: "starter plan",
  metricCaption: "Program modules respect time constraints, feeding schedules, and care-team coordination.",
  searchPlaceholder: "Search postpartum, parents, or support",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what new parents seeking support for mood, identity, and adjustment need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Start support",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a postpartum therapy program page.",
    "metric": "4 wk",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after start support, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "postpartum",
    "detail": "Visitors can understand a postpartum therapy program page without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "parents",
  ...
  },
  {
    "label": "Begin care",
    "value": "4 wk",
    "detail": "Program modules respect time constraints, feeding schedules, and care-team coordination."
  }
];
const RESOURCES = [
  "Program guide",
...
export default function PostpartumTherapyProgram() {
