...
/**
 * @file page.tsx
 * @input Deterministic Copyhold fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Newsroom Correction Desk: Editorial corrections desk for claims, source notes, legal review, update placement, and publish history.
...
const BRAND = "Copyhold";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Newsroom priority packet",
    "owner": "Theo Grant",
    "state": "risk",
    "progress": 72,
    "metric": "7 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final correction check before the handoff can leave review.",
    "points": [
      22,
      39,
      31,
  ...
  {
    "id": "item-02",
    "title": "Copyhold exception sweep",
    "owner": "Ana Ito",
    "state": "review",
    "progress": 83,
    "metric": "9 queued",
  ...
  {
    "id": "item-03",
    "title": "Correction readiness lane",
    "owner": "Caleb Moss",
    "state": "ready",
    "progress": 99,
    "metric": "73% ready",
  ...
  {
    "id": "item-04",
    "title": "Copyhold owner follow-up",
    "owner": "Eli Stone",
    "state": "risk",
    "progress": 76,
    "metric": "5 handoffs",
  ...
  {
    "id": "item-05",
    "title": "Newsroom signed-off path",
    "owner": "Jon Bell",
    "state": "ready",
    "progress": 100,
    "metric": "13 artifacts",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Newsroom Correction Desk</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Newsroom Correction Desk command rail">
          ...
          <section className="panel" aria-label="Newsroom Correction Desk queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Newsroom Correction Desk detail inspector">
            <div className="panelHeader">
