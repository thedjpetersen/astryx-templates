...
/**
 * @file page.tsx
 * @input Deterministic Dispatchly fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Field Service Dispatch Radar: Dispatcher radar for technician routes, skill matches, SLA risk, parts readiness, and reroute actions.
...
const SCOPE = "tpl-field-service-dispatch-radar";
const BRAND = "Dispatchly";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Field priority packet",
    "owner": "Owen Ellis",
    "state": "risk",
    "progress": 72,
    "metric": "4 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final service check before the handoff can leave review.",
    "points": [
      22,
      40,
      31,
  ...
  {
    "id": "item-02",
    "title": "Dispatchly exception sweep",
    "owner": "Leah Chen",
    "state": "review",
    "progress": 83,
    "metric": "13 queued",
  ...
  {
    "id": "item-04",
    "title": "Dispatchly owner follow-up",
    "owner": "Drew Patel",
    "state": "risk",
    "progress": 76,
    "metric": "3 handoffs",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              <p className="eyebrow">{BRAND} / Operations</p>
              <h1>Field Service Dispatch Radar</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Field Service Dispatch Radar command rail">
          ...
          <section className="panel" aria-label="Field Service Dispatch Radar queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Field Service Dispatch Radar detail inspector">
            <div className="panelHeader">
