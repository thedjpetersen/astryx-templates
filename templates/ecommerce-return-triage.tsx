...
/**
 * @file page.tsx
 * @input Deterministic Returnly fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Return Triage Workbench: Returns operations workbench for reason clusters, fraud signals, inspection status, and refund routing.
...
const SCOPE = "tpl-ecommerce-return-triage";
const BRAND = "Returnly";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Return priority packet",
    "owner": "Owen Ellis",
    "state": "risk",
    "progress": 51,
    "metric": "3 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final triage check before the handoff can leave review.",
    "points": [
      22,
      37,
      31,
  ...
  {
    "id": "item-02",
    "title": "Returnly exception sweep",
    "owner": "Leah Chen",
    "state": "review",
    "progress": 62,
    "metric": "11 queued",
  ...
  {
    "id": "item-04",
    "title": "Returnly owner follow-up",
    "owner": "Drew Patel",
    "state": "risk",
    "progress": 55,
    "metric": "3 handoffs",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Return Triage Workbench command rail">
          ...
          <section className="panel" aria-label="Return Triage Workbench queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Return Triage Workbench detail inspector">
            <div className="panelHeader">
