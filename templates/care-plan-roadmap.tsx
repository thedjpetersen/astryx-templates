...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Care Plan Roadmap. No Date.now(),
 ...
 * @output Care Plan Roadmap: Therapy website experience for a therapy care plan roadmap, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients orienting around phases of care and expected checkpoints. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template care-plan-roadmap`
 *
...
const SCOPE = "tpl-care-plan-roadmap";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Care Delivery",
  title: "Care Plan Roadmap",
  focus: "a therapy care plan roadmap",
  audience: "clients orienting around phases of care and expected checkpoints",
  primary: "Review roadmap",
  secondary: "Download plan",
  metric: "8 wk",
  metricLabel: "care horizon",
  metricCaption: "Milestones, measures, and shared responsibilities are presented together.",
  searchPlaceholder: "Search phase plan, measures, or review",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients orienting around phases of care and expected checkpoints need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Review roadmap",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a therapy care plan roadmap.",
    "metric": "8 wk",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after review roadmap, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "phase plan",
    "detail": "Visitors can understand a therapy care plan roadmap without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "measures",
  ...
  },
  {
    "label": "Begin care",
    "value": "8 wk",
    "detail": "Milestones, measures, and shared responsibilities are presented together."
  }
];
const RESOURCES = [
  "Care Delivery guide",
...
export default function CarePlanRoadmap() {
