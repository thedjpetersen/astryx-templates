...
/**
 * @file page.tsx
 * @input Deterministic Stackline fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Library Hold Fulfillment: Circulation operations view for holds, pickups, interlibrary loans, shelf exceptions, and patron notices.
...
const SCOPE = "tpl-library-hold-fulfillment";
const BRAND = "Stackline";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Library priority packet",
    "owner": "Theo Grant",
    "state": "risk",
    "progress": 60,
    "metric": "3 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final hold check before the handoff can leave review.",
    "points": [
      22,
      35,
      31,
  ...
  {
    "id": "item-02",
    "title": "Stackline exception sweep",
    "owner": "Ana Ito",
    "state": "review",
    "progress": 71,
    "metric": "11 queued",
  ...
  {
    "id": "item-04",
    "title": "Stackline owner follow-up",
    "owner": "Eli Stone",
    "state": "risk",
    "progress": 64,
    "metric": "5 handoffs",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Library Hold Fulfillment</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Library Hold Fulfillment command rail">
          ...
          <section className="panel" aria-label="Library Hold Fulfillment queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Library Hold Fulfillment detail inspector">
            <div className="panelHeader">
