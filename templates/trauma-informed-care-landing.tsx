...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Trauma-informed Care Landing. No Date.now(),
 ...
 * @output Trauma-informed Care Landing: Therapy website experience for a trauma-informed therapy landing page, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients seeking safety-forward care descriptions. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template trauma-informed-care-landing`
 *
...
const SCOPE = "tpl-trauma-informed-care-landing";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Specialty Care",
  title: "Trauma-informed Care Landing",
  focus: "a trauma-informed therapy landing page",
  audience: "clients seeking safety-forward care descriptions",
  primary: "Find support",
  secondary: "Read approach",
  metric: "4",
  metricLabel: "care principles",
  metricCaption: "The page explains pacing, choice, collaboration, and safety without pressure.",
  searchPlaceholder: "Search trauma, stabilization, or choice",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients seeking safety-forward care descriptions need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Find support",
    "icon": "search",
    "tone": "mint"
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for a trauma-informed therapy landing page.",
    "metric": "4",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after find support, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "trauma",
    "detail": "Visitors can understand a trauma-informed therapy landing page without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "stabilization",
  ...
  },
  {
    "label": "Begin care",
    "value": "4",
    "detail": "The page explains pacing, choice, collaboration, and safety without pressure."
  }
];
const RESOURCES = [
...
export default function TraumaInformedCareLanding() {
