...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Anxiety Program Overview. No Date.now(),
 ...
 * @output Anxiety Program Overview: Therapy website experience for a structured anxiety care program overview, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients comparing therapy paths for anxiety symptoms. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template anxiety-program-overview`
 *
...
const SCOPE = "tpl-anxiety-program-overview";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Program",
  title: "Anxiety Program Overview",
  focus: "a structured anxiety care program overview",
  audience: "clients comparing therapy paths for anxiety symptoms",
  primary: "Start program",
  secondary: "See skills",
  metric: "6 wk",
  metricLabel: "program arc",
  metricCaption: "Program expectations, skills, therapist role, and progress checks sit together.",
  searchPlaceholder: "Search CBT, exposure, or skills",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients comparing therapy paths for anxiety symptoms need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Start program",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a structured anxiety care program overview.",
    "metric": "6 wk",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after start program, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "CBT",
    "detail": "Visitors can understand a structured anxiety care program overview without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "exposure",
  ...
  },
  {
    "label": "Begin care",
    "value": "6 wk",
    "detail": "Program expectations, skills, therapist role, and progress checks sit together."
  }
];
const RESOURCES = [
  "Program guide",
...
export default function AnxietyProgramOverview() {
