...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Group Therapy Series Page. No Date.now(),
 ...
 * @output Group Therapy Series Page: Therapy website experience for a group therapy program landing page, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients considering structured groups and cohorts. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template group-therapy-series-page`
 *
...
const SCOPE = "tpl-group-therapy-series-page";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Specialty Care",
  title: "Group Therapy Series Page",
  focus: "a group therapy program landing page",
  audience: "clients considering structured groups and cohorts",
  primary: "Join group",
  secondary: "See schedule",
  metric: "8 seats",
  metricLabel: "open cohort",
  metricCaption: "Session cadence, facilitator fit, and group norms are easy to compare.",
  searchPlaceholder: "Search cohort, skills group, or facilitator",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients considering structured groups and cohorts need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Join group",
    "icon": "search",
    "tone": "mint"
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for a group therapy program landing page.",
    "metric": "8 seats",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after join group, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "cohort",
    "detail": "Visitors can understand a group therapy program landing page without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "skills group",
  ...
  },
  {
    "label": "Begin care",
    "value": "8 seats",
    "detail": "Session cadence, facilitator fit, and group norms are easy to compare."
  }
];
const RESOURCES = [
...
export default function GroupTherapySeriesPage() {
