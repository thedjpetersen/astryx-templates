...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Clinical Resource Library. No Date.now(),
 ...
 * @output Clinical Resource Library: Therapy website experience for a therapy resource library, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients browsing worksheets, articles, and skills between sessions. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template clinical-resource-library`
 *
...
const SCOPE = "tpl-clinical-resource-library";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Content",
  title: "Clinical Resource Library",
  focus: "a therapy resource library",
  audience: "clients browsing worksheets, articles, and skills between sessions",
  primary: "Open resource",
  secondary: "Save collection",
  metric: "54",
  metricLabel: "resources",
  metricCaption: "Resources are grouped by need, modality, reading time, and therapist recommendation.",
  searchPlaceholder: "Search worksheets, skills, or articles",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients browsing worksheets, articles, and skills between sessions need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Open resource",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a therapy resource library.",
    "metric": "54",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after open resource, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "worksheets",
    "detail": "Visitors can understand a therapy resource library without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "skills",
  ...
  },
  {
    "label": "Begin care",
    "value": "54",
    "detail": "Resources are grouped by need, modality, reading time, and therapist recommendation."
  }
];
const RESOURCES = [
  "Content guide",
...
export default function ClinicalResourceLibrary() {
