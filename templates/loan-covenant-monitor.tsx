...
/**
 * @file page.tsx
 * @input Deterministic Ledgerline fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Loan Covenant Monitor: Commercial loan covenant monitor with breach forecasts, waiver packages, ratio evidence, and borrower follow-ups.
...
const SCOPE = "tpl-loan-covenant-monitor";
const BRAND = "Ledgerline";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Loan priority packet",
    "owner": "Riya Shah",
    "state": "risk",
    "progress": 66,
    "metric": "4 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final covenant check before the handoff can leave review.",
    "points": [
      22,
      40,
      31,
  ...
  {
    "id": "item-02",
    "title": "Ledgerline exception sweep",
    "owner": "Noah Brooks",
    "state": "review",
    "progress": 77,
    "metric": "8 queued",
  ...
  {
    "id": "item-04",
    "title": "Ledgerline owner follow-up",
    "owner": "Nora Ames",
    "state": "review",
    "progress": 70,
    "metric": "4 handoffs",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Loan Covenant Monitor command rail">
          ...
          <section className="panel" aria-label="Loan Covenant Monitor queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Loan Covenant Monitor detail inspector">
            <div className="panelHeader">
