...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Crisis Resource Handoff. No Date.now(),
 ...
 * @output Crisis Resource Handoff: Therapy website experience for a crisis resource handoff page, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients needing urgent guidance outside routine therapy messaging. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template crisis-resource-handoff`
 *
...
const SCOPE = "tpl-crisis-resource-handoff";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Safety",
  title: "Crisis Resource Handoff",
  focus: "a crisis resource handoff page",
  audience: "clients needing urgent guidance outside routine therapy messaging",
  primary: "View resources",
  secondary: "Contact support",
  metric: "24/7",
  metricLabel: "resource access",
  metricCaption: "The surface distinguishes emergency, urgent, and non-urgent support paths.",
  searchPlaceholder: "Search crisis, urgent, or resources",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients needing urgent guidance outside routine therapy messaging need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "View resources",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a crisis resource handoff page.",
    "metric": "24/7",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after view resources, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "crisis",
    "detail": "Visitors can understand a crisis resource handoff page without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "urgent",
  ...
  },
  {
    "label": "Begin care",
    "value": "24/7",
    "detail": "The surface distinguishes emergency, urgent, and non-urgent support paths."
  }
];
const RESOURCES = [
  "Safety guide",
...
export default function CrisisResourceHandoff() {
