...
/**
 * @file page.tsx
 * @input Deterministic Binwise fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Waste Route Exception Board: Sanitation exception board for missed pickups, blocked bins, route proof, and resident follow-up.
...
const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Waste priority packet",
    "owner": "Theo Grant",
    "state": "risk",
    "progress": 51,
    "metric": "6 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final route check before the handoff can leave review.",
    "points": [
      22,
      36,
      31,
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Waste Route Exception Board</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Waste Route Exception Board command rail">
          ...
          <section className="panel" aria-label="Waste Route Exception Board queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Waste Route Exception Board detail inspector">
            <div className="panelHeader">
