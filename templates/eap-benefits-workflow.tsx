...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for EAP Benefits Workflow. No Date.now(),
 ...
 * @output EAP Benefits Workflow: Therapy website experience for an employee assistance benefits workflow, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients using employer-sponsored therapy benefits. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template eap-benefits-workflow`
 *
...
const SCOPE = "tpl-eap-benefits-workflow";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Access",
  title: "EAP Benefits Workflow",
  focus: "an employee assistance benefits workflow",
  audience: "clients using employer-sponsored therapy benefits",
  primary: "Use EAP benefit",
  secondary: "Check sessions",
  metric: "6",
  metricLabel: "covered visits",
  metricCaption: "The workflow explains eligibility, privacy from employer, and remaining sessions.",
  searchPlaceholder: "Search EAP, benefits, or privacy",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients using employer-sponsored therapy benefits need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Use EAP benefit",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for an employee assistance benefits workflow.",
    "metric": "6",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after use eap benefit, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "EAP",
    "detail": "Visitors can understand an employee assistance benefits workflow without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "benefits",
  ...
  },
  {
    "label": "Begin care",
    "value": "6",
    "detail": "The workflow explains eligibility, privacy from employer, and remaining sessions."
  }
];
const RESOURCES = [
  "Access guide",
...
export default function EapBenefitsWorkflow() {
