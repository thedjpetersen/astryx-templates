...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Provider Calendar Capacity. No Date.now(),
 ...
 * @output Provider Calendar Capacity: Therapy website experience for a provider availability and capacity planner, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for practice operators balancing therapist supply and client demand. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template provider-calendar-capacity`
 *
...
const SCOPE = "tpl-provider-calendar-capacity";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Practice Ops",
  title: "Provider Calendar Capacity",
  focus: "a provider availability and capacity planner",
  audience: "practice operators balancing therapist supply and client demand",
  primary: "Adjust capacity",
  secondary: "Open slots",
  metric: "124",
  metricLabel: "open hours",
  metricCaption: "The planner highlights slot mix, waitlist pressure, and clinician preferences.",
  searchPlaceholder: "Search capacity, waitlist, or schedule",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what practice operators balancing therapist supply and client demand need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Adjust capacity",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a provider availability and capacity planner.",
    "metric": "124",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after adjust capacity, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "capacity",
    "detail": "Visitors can understand a provider availability and capacity planner without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "waitlist",
  ...
  },
  {
    "label": "Begin care",
    "value": "124",
    "detail": "The planner highlights slot mix, waitlist pressure, and clinician preferences."
  }
];
const RESOURCES = [
  "Practice Ops guide",
...
export default function ProviderCalendarCapacity() {
