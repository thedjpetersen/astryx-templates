...
/**
 * @file page.tsx
 * @input Deterministic Promptwell fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Prompt Experiment Lab: Prompt test lab with variant cohorts, rubric scores, failure clusters, and promotion readiness.
...
const BRAND = "Promptwell";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Prompt priority packet",
    "owner": "Riya Shah",
    "state": "risk",
    "progress": 51,
    "metric": "7 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final experiment check before the handoff can leave review.",
    "points": [
      22,
      40,
      31,
  ...
  {
    "id": "item-02",
    "title": "Promptwell exception sweep",
    "owner": "Noah Brooks",
    "state": "review",
    "progress": 62,
    "metric": "12 queued",
  ...
  {
    "id": "item-03",
    "title": "Experiment readiness lane",
    "owner": "Priya Nair",
    "state": "ready",
    "progress": 78,
    "metric": "71% ready",
  ...
  {
    "id": "item-04",
    "title": "Promptwell owner follow-up",
    "owner": "Nora Ames",
    "state": "review",
    "progress": 55,
    "metric": "4 handoffs",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Prompt Experiment Lab command rail">
          ...
          <section className="panel" aria-label="Prompt Experiment Lab queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Prompt Experiment Lab detail inspector">
            <div className="panelHeader">
