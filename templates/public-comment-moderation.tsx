...
/**
 * @file page.tsx
 * @input Deterministic Hearingline fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Public Comment Moderation: Civic hearing moderation console for speaker queues, duplicate comments, topic clusters, and rules review.
...
const BRAND = "Hearingline";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Public priority packet",
    "owner": "Mina Park",
    "state": "risk",
    "progress": 75,
    "metric": "3 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final comment check before the handoff can leave review.",
    "points": [
      22,
      40,
      31,
  ...
  {
    "id": "item-02",
    "title": "Hearingline exception sweep",
    "owner": "Sam Rivera",
    "state": "review",
    "progress": 86,
    "metric": "10 queued",
  ...
  {
    "id": "item-04",
    "title": "Hearingline owner follow-up",
    "owner": "Maya Fox",
    "state": "review",
    "progress": 79,
    "metric": "2 handoffs",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Public Comment Moderation</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Public Comment Moderation command rail">
          ...
          <section className="panel" aria-label="Public Comment Moderation queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Public Comment Moderation detail inspector">
            <div className="panelHeader">
