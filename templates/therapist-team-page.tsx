...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Therapist Team Page. No Date.now(),
 ...
 * @output Therapist Team Page: Therapy website experience for a therapist team and practice page, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients comparing a practice team and deciding who to contact. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template therapist-team-page`
 *
...
const SCOPE = "tpl-therapist-team-page";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Discovery",
  title: "Therapist Team Page",
  focus: "a therapist team and practice page",
  audience: "clients comparing a practice team and deciding who to contact",
  primary: "Meet the team",
  secondary: "Filter clinicians",
  metric: "23",
  metricLabel: "clinicians",
  metricCaption: "Team cards balance warmth, credentials, availability, and specialty fit.",
  searchPlaceholder: "Search team, credentials, or availability",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients comparing a practice team and deciding who to contact need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Meet the team",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a therapist team and practice page.",
    "metric": "23",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after meet the team, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "team",
    "detail": "Visitors can understand a therapist team and practice page without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "credentials",
  ...
  },
  {
    "label": "Begin care",
    "value": "23",
    "detail": "Team cards balance warmth, credentials, availability, and specialty fit."
  }
];
const RESOURCES = [
  "Discovery guide",
...
export default function TherapistTeamPage() {
