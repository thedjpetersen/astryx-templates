...
/**
 * @file page.tsx
 * @input Deterministic Thirdrail fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Vendor Risk Renewal: Third-party renewal console for risk attestations, control gaps, contract dates, and escalation owners.
...
const BRAND = "Thirdrail";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Vendor priority packet",
    "owner": "Riya Shah",
    "state": "risk",
    "progress": 78,
    "metric": "3 blockers",
  ...
  {
    "id": "item-02",
    "title": "Thirdrail exception sweep",
    "owner": "Noah Brooks",
    "state": "review",
    "progress": 89,
    "metric": "12 queued",
  ...
  {
    "id": "item-04",
    "title": "Thirdrail owner follow-up",
    "owner": "Nora Ames",
    "state": "review",
    "progress": 82,
    "metric": "4 handoffs",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Vendor Risk Renewal command rail">
          ...
          <section className="panel" aria-label="Vendor Risk Renewal queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Vendor Risk Renewal detail inspector">
            <div className="panelHeader">
