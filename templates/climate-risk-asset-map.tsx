...
/**
 * @file page.tsx
 * @input Deterministic Resilio fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Climate Risk Asset Map: Asset-risk map for flood, heat, outage exposure, mitigation projects, and insurance evidence.
 * @position Page template; emitted by `astryx template climate-risk-asset-map`
 *
...
const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Climate priority packet",
    "owner": "Owen Ellis",
    "state": "risk",
    "progress": 63,
    "metric": "7 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final risk check before the handoff can leave review.",
    "points": [
      22,
      34,
      31,
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Climate Risk Asset Map command rail">
          ...
          <section className="panel" aria-label="Climate Risk Asset Map queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Climate Risk Asset Map detail inspector">
            <div className="panelHeader">
