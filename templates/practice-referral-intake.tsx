...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Practice Referral Intake. No Date.now(),
 ...
 * @output Practice Referral Intake: Therapy website experience for a practice referral intake board, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for care coordinators triaging referrals and match readiness. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template practice-referral-intake`
 *
...
const SCOPE = "tpl-practice-referral-intake";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Practice Ops",
  title: "Practice Referral Intake",
  focus: "a practice referral intake board",
  audience: "care coordinators triaging referrals and match readiness",
  primary: "Triage referral",
  secondary: "Assign owner",
  metric: "27",
  metricLabel: "new referrals",
  metricCaption: "Referral source, urgency, specialty fit, and paperwork blockers share one board.",
  searchPlaceholder: "Search referral, triage, or match",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what care coordinators triaging referrals and match readiness need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Triage referral",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a practice referral intake board.",
    "metric": "27",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after triage referral, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "referral",
    "detail": "Visitors can understand a practice referral intake board without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "triage",
  ...
  },
  {
    "label": "Begin care",
    "value": "27",
    "detail": "Referral source, urgency, specialty fit, and paperwork blockers share one board."
  }
];
const RESOURCES = [
  "Practice Ops guide",
...
export default function PracticeReferralIntake() {
