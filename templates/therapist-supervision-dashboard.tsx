...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Therapist Supervision Dashboard. No Date.now(),
 ...
 * @output Therapist Supervision Dashboard: Therapy website experience for a clinical supervision dashboard, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for supervisors reviewing caseload health and therapist support needs. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template therapist-supervision-dashboard`
 *
...
const SCOPE = "tpl-therapist-supervision-dashboard";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Practice Ops",
  title: "Therapist Supervision Dashboard",
  focus: "a clinical supervision dashboard",
  audience: "supervisors reviewing caseload health and therapist support needs",
  primary: "Review cases",
  secondary: "Add note",
  metric: "18",
  metricLabel: "active cases",
  metricCaption: "Supervision themes, acuity, documentation, and follow-up are visible at a glance.",
  searchPlaceholder: "Search supervision, acuity, or caseload",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what supervisors reviewing caseload health and therapist support needs need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Review cases",
    "icon": "search",
    "tone": "mint"
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for a clinical supervision dashboard.",
    "metric": "18",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after review cases, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "supervision",
    "detail": "Visitors can understand a clinical supervision dashboard without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "acuity",
  ...
  },
  {
    "label": "Begin care",
    "value": "18",
    "detail": "Supervision themes, acuity, documentation, and follow-up are visible at a glance."
  }
];
const RESOURCES = [
  "Practice Ops guide",
...
export default function TherapistSupervisionDashboard() {
