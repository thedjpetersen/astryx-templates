...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Between-session Homework. No Date.now(),
 ...
 * @output Between-session Homework: Therapy website experience for a between-session practice assignment page, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients completing exercises assigned by their therapist. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template between-session-homework`
 *
...
const SCOPE = "tpl-between-session-homework";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Care Delivery",
  title: "Between-session Homework",
  focus: "a between-session practice assignment page",
  audience: "clients completing exercises assigned by their therapist",
  primary: "Complete practice",
  secondary: "Ask for help",
  metric: "3",
  metricLabel: "active tasks",
  metricCaption: "Practice cards include instructions, barriers, confidence, and therapist feedback.",
  searchPlaceholder: "Search skills, worksheets, or reminders",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients completing exercises assigned by their therapist need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Complete practice",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a between-session practice assignment page.",
    "metric": "3",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after complete practice, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "skills",
    "detail": "Visitors can understand a between-session practice assignment page without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "worksheets",
  ...
  },
  {
    "label": "Begin care",
    "value": "3",
    "detail": "Practice cards include instructions, barriers, confidence, and therapist feedback."
  }
];
const RESOURCES = [
  "Care Delivery guide",
...
export default function BetweenSessionHomework() {
