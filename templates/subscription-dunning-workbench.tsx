...
/**
 * @file page.tsx
 * @input Deterministic Retrydesk fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Dunning Workbench: Subscription recovery desk for failed payments, retry paths, outreach copy, and churn-risk saves.
 * @position Page template; emitted by `astryx template subscription-dunning-workbench`
 *
...
const BRAND = "Retrydesk";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Dunning priority packet",
    "owner": "Riya Shah",
    "state": "risk",
    "progress": 54,
    "metric": "4 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final commerce check before the handoff can leave review.",
    "points": [
      22,
      38,
      31,
  ...
  {
    "id": "item-02",
    "title": "Retrydesk exception sweep",
    "owner": "Noah Brooks",
    "state": "review",
    "progress": 65,
    "metric": "12 queued",
  ...
  {
    "id": "item-04",
    "title": "Retrydesk owner follow-up",
    "owner": "Nora Ames",
    "state": "review",
    "progress": 58,
    "metric": "4 handoffs",
...
export default function SubscriptionDunningWorkbenchTemplate() {
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Dunning Workbench command rail">
          ...
          <section className="panel" aria-label="Dunning Workbench queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Dunning Workbench detail inspector">
            <div className="panelHeader">
