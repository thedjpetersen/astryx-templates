...
/**
 * @file page.tsx
 * @input Deterministic RenewalOS fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Customer Health Renewals: CS renewal desk for health signals, product gaps, champions, mutual action plans, and risk save motions.
...
const BRAND = "RenewalOS";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Customer priority packet",
    "owner": "Riya Shah",
    "state": "risk",
    "progress": 63,
    "metric": "6 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final health check before the handoff can leave review.",
    "points": [
      22,
      37,
      31,
  ...
  {
    "id": "item-02",
    "title": "RenewalOS exception sweep",
    "owner": "Noah Brooks",
    "state": "review",
    "progress": 74,
    "metric": "10 queued",
  ...
  {
    "id": "item-04",
    "title": "RenewalOS owner follow-up",
    "owner": "Nora Ames",
    "state": "review",
    "progress": 67,
    "metric": "4 handoffs",
  ...
  {
    "id": "item-05",
    "title": "Customer signed-off path",
    "owner": "Hana Roy",
    "state": "ready",
    "progress": 98,
    "metric": "14 artifacts",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Customer Health Renewals</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Customer Health Renewals command rail">
          ...
          <section className="panel" aria-label="Customer Health Renewals queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Customer Health Renewals detail inspector">
            <div className="panelHeader">
