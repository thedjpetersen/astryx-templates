...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Mood Check-in Mobile. No Date.now(),
 ...
 * @output Mood Check-in Mobile: Therapy website experience for a mobile mood and symptoms check-in, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients sharing quick context before or between sessions. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template mood-checkin-mobile`
 *
...
const SCOPE = "tpl-mood-checkin-mobile";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Care Delivery",
  title: "Mood Check-in Mobile",
  focus: "a mobile mood and symptoms check-in",
  audience: "clients sharing quick context before or between sessions",
  primary: "Log check-in",
  secondary: "View pattern",
  metric: "90 sec",
  metricLabel: "daily check",
  metricCaption: "A low-friction mobile surface captures mood, sleep, stress, and notes.",
  searchPlaceholder: "Search mood, sleep, or stress",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients sharing quick context before or between sessions need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Log check-in",
    "icon": "search",
    "tone": "mint"
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for a mobile mood and symptoms check-in.",
    "metric": "90 sec",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after log check-in, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "mood",
    "detail": "Visitors can understand a mobile mood and symptoms check-in without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "sleep",
  ...
  },
  {
    "label": "Begin care",
    "value": "90 sec",
    "detail": "A low-friction mobile surface captures mood, sleep, stress, and notes."
  }
];
const RESOURCES = [
  "Care Delivery guide",
...
export default function MoodCheckinMobile() {
