...
/**
 * @file page.tsx
 * @input Deterministic Trackwell fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Rail Maintenance Window Planner: Track-work planner for possession windows, crew staging, train conflicts, and safety authority approvals.
...
const BRAND = "Trackwell";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Rail priority packet",
    "owner": "Riya Shah",
    "state": "risk",
    "progress": 60,
    "metric": "4 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final maintenance check before the handoff can leave review.",
    "points": [
      22,
      39,
      31,
  ...
  {
    "id": "item-02",
    "title": "Trackwell exception sweep",
    "owner": "Noah Brooks",
    "state": "review",
    "progress": 71,
    "metric": "10 queued",
  ...
  {
    "id": "item-03",
    "title": "Maintenance readiness lane",
    "owner": "Priya Nair",
    "state": "ready",
    "progress": 87,
    "metric": "80% ready",
  ...
  {
    "id": "item-04",
    "title": "Trackwell owner follow-up",
    "owner": "Nora Ames",
    "state": "review",
    "progress": 64,
    "metric": "4 handoffs",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Rail Maintenance Window Planner</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Rail Maintenance Window Planner command rail">
          ...
          <section className="panel" aria-label="Rail Maintenance Window Planner queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Rail Maintenance Window Planner detail inspector">
            <div className="panelHeader">
