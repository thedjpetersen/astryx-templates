...
/**
 * @file page.tsx
 * @input Deterministic Prooflane fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Audit Evidence Tracker: Audit PBC tracker that reconciles evidence requests, control owners, review notes, and late-close risk.
...
const BRAND = "Prooflane";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Audit priority packet",
    "owner": "Mina Park",
    "state": "risk",
    "progress": 72,
    "metric": "6 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final evidence check before the handoff can leave review.",
    "points": [
      22,
      35,
      31,
  ...
  {
    "id": "item-02",
    "title": "Prooflane exception sweep",
    "owner": "Sam Rivera",
    "state": "review",
    "progress": 83,
    "metric": "10 queued",
  ...
  {
    "id": "item-04",
    "title": "Prooflane owner follow-up",
    "owner": "Maya Fox",
    "state": "review",
    "progress": 76,
    "metric": "2 handoffs",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              <p className="eyebrow">{BRAND} / Finance</p>
              <h1>Audit Evidence Tracker</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Audit Evidence Tracker command rail">
          ...
          <section className="panel" aria-label="Audit Evidence Tracker queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Audit Evidence Tracker detail inspector">
            <div className="panelHeader">
