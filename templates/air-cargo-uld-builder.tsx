...
/**
 * @file page.tsx
 * @input Deterministic Loadgrid fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Air Cargo ULD Builder: Cargo build console for ULD positions, hazmat separation, weight balance, and flight cutoff readiness.
...
const BRAND = "Loadgrid";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Air priority packet",
    "owner": "Mina Park",
    "state": "risk",
    "progress": 66,
    "metric": "6 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final cargo check before the handoff can leave review.",
    "points": [
      22,
      34,
      31,
  ...
  {
    "id": "item-02",
    "title": "Loadgrid exception sweep",
    "owner": "Sam Rivera",
    "state": "review",
    "progress": 77,
    "metric": "12 queued",
  ...
  {
    "id": "item-04",
    "title": "Loadgrid owner follow-up",
    "owner": "Maya Fox",
    "state": "review",
    "progress": 70,
    "metric": "2 handoffs",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Air Cargo ULD Builder command rail">
          ...
          <section className="panel" aria-label="Air Cargo ULD Builder queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Air Cargo ULD Builder detail inspector">
            <div className="panelHeader">
