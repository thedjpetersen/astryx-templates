...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Note Template Library. No Date.now(),
 ...
 * @output Note Template Library: Therapy website experience for a therapist documentation template library, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clinicians choosing structured notes for common therapy workflows. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template therapist-note-template-library`
 *
...
const SCOPE = "tpl-therapist-note-template-library";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Clinical Tools",
  title: "Note Template Library",
  focus: "a therapist documentation template library",
  audience: "clinicians choosing structured notes for common therapy workflows",
  primary: "Use template",
  secondary: "Preview note",
  metric: "36",
  metricLabel: "templates",
  metricCaption: "Templates are organized by modality, risk level, session type, and documentation need.",
  searchPlaceholder: "Search SOAP, DAP, or treatment plan",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clinicians choosing structured notes for common therapy workflows need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Use template",
    "icon": "search",
    "tone": "mint"
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for a therapist documentation template library.",
    "metric": "36",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after use template, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "SOAP",
    "detail": "Visitors can understand a therapist documentation template library without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "DAP",
  ...
  },
  {
    "label": "Begin care",
    "value": "36",
    "detail": "Templates are organized by modality, risk level, session type, and documentation need."
  }
];
const RESOURCES = [
  "Clinical Tools guide",
...
export default function TherapistNoteTemplateLibrary() {
