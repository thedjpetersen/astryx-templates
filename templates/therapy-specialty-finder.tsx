...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Specialty Finder. No Date.now(),
 ...
 * @output Specialty Finder: Therapy website experience for a therapy specialty finder, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients translating needs into therapist specialty filters. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template therapy-specialty-finder`
 *
...
const SCOPE = "tpl-therapy-specialty-finder";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Discovery",
  title: "Specialty Finder",
  focus: "a therapy specialty finder",
  audience: "clients translating needs into therapist specialty filters",
  primary: "Find specialty",
  secondary: "Compare options",
  metric: "18",
  metricLabel: "specialties",
  metricCaption: "Plain-language needs map to specialties without making the client self-diagnose.",
  searchPlaceholder: "Search specialties, needs, or fit",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients translating needs into therapist specialty filters need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Find specialty",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a therapy specialty finder.",
    "metric": "18",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after find specialty, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "specialties",
    "detail": "Visitors can understand a therapy specialty finder without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "needs",
  ...
  },
  {
    "label": "Begin care",
    "value": "18",
    "detail": "Plain-language needs map to specialties without making the client self-diagnose."
  }
];
const RESOURCES = [
  "Discovery guide",
...
export default function TherapySpecialtyFinder() {
