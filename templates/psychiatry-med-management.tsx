...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Psychiatry Med Management. No Date.now(),
 ...
 * @output Psychiatry Med Management: Therapy website experience for a psychiatry medication-management companion page, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients coordinating therapy with psychiatric medication visits. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template psychiatry-med-management`
 *
...
const SCOPE = "tpl-psychiatry-med-management";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Program",
  title: "Psychiatry Med Management",
  focus: "a psychiatry medication-management companion page",
  audience: "clients coordinating therapy with psychiatric medication visits",
  primary: "Request review",
  secondary: "Track questions",
  metric: "30 min",
  metricLabel: "med visit",
  metricCaption: "Questions, side effects, refill timing, and therapist collaboration are framed clearly.",
  searchPlaceholder: "Search psychiatry, meds, or coordination",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients coordinating therapy with psychiatric medication visits need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Request review",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a psychiatry medication-management companion page.",
    "metric": "30 min",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after request review, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "psychiatry",
    "detail": "Visitors can understand a psychiatry medication-management companion page without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "meds",
  ...
  },
  {
    "label": "Begin care",
    "value": "30 min",
    "detail": "Questions, side effects, refill timing, and therapist collaboration are framed clearly."
  }
];
const RESOURCES = [
  "Program guide",
...
export default function PsychiatryMedManagement() {
