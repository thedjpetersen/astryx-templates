...
/**
 * @file page.tsx
 * @input Deterministic Shiftline fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Shift Swap Console: Restaurant staffing console for swap requests, coverage gaps, overtime risk, and manager approvals.
...
const SCOPE = "tpl-restaurant-shift-swap-console";
const BRAND = "Shiftline";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Shift priority packet",
    "owner": "Riya Shah",
    "state": "risk",
    "progress": 75,
    "metric": "5 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final swap check before the handoff can leave review.",
    "points": [
      22,
      34,
      31,
  ...
  {
    "id": "item-02",
    "title": "Shiftline exception sweep",
    "owner": "Noah Brooks",
    "state": "review",
    "progress": 86,
    "metric": "8 queued",
  ...
  {
    "id": "item-04",
    "title": "Shiftline owner follow-up",
    "owner": "Nora Ames",
    "state": "review",
    "progress": 79,
    "metric": "4 handoffs",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              <p className="eyebrow">{BRAND} / Hospitality</p>
              <h1>Shift Swap Console</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Shift Swap Console command rail">
          ...
          <section className="panel" aria-label="Shift Swap Console queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Shift Swap Console detail inspector">
            <div className="panelHeader">
