...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Superbill Center. No Date.now(),
 ...
 * @output Superbill Center: Therapy website experience for a superbill and payment document center, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients downloading therapy billing documents for reimbursement. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template billing-superbill-center`
 *
...
const SCOPE = "tpl-billing-superbill-center";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Billing",
  title: "Superbill Center",
  focus: "a superbill and payment document center",
  audience: "clients downloading therapy billing documents for reimbursement",
  primary: "Download superbill",
  secondary: "Filter dates",
  metric: "12",
  metricLabel: "documents",
  metricCaption: "Invoices, superbills, payment status, and reimbursement guidance are grouped.",
  searchPlaceholder: "Search superbill, payments, or reimbursement",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients downloading therapy billing documents for reimbursement need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Download superbill",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a superbill and payment document center.",
    "metric": "12",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after download superbill, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "superbill",
    "detail": "Visitors can understand a superbill and payment document center without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "payments",
  ...
  },
  {
    "label": "Begin care",
    "value": "12",
    "detail": "Invoices, superbills, payment status, and reimbursement guidance are grouped."
  }
];
const RESOURCES = [
  "Billing guide",
...
export default function BillingSuperbillCenter() {
