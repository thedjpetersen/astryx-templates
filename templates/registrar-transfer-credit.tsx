...
/**
 * @file page.tsx
 * @input Deterministic Equiv fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Transfer Credit Workbench: Transfer-credit review queue for equivalencies, syllabus evidence, degree impact, and evaluator decisions.
...
const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Transfer priority packet",
    "owner": "Riya Shah",
    "state": "risk",
    "progress": 57,
    "metric": "7 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final credit check before the handoff can leave review.",
    "points": [
      22,
      34,
      31,
  ...
  {
    "id": "item-05",
    "title": "Transfer signed-off path",
    "owner": "Hana Roy",
    "state": "ready",
    "progress": 92,
    "metric": "17 artifacts",
...
export default function RegistrarTransferCreditTemplate() {
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              <p className="eyebrow">{BRAND} / Education</p>
              <h1>Transfer Credit Workbench</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Transfer Credit Workbench command rail">
          ...
          <section className="panel" aria-label="Transfer Credit Workbench queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Transfer Credit Workbench detail inspector">
            <div className="panelHeader">
