...
/**
 * @file page.tsx
 * @input Deterministic CivicGrant fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Grant Reporting Calendar: Grant compliance calendar joining deliverables, reimbursements, evidence uploads, and funder review states.
...
const BRAND = "CivicGrant";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Grant priority packet",
    "owner": "Theo Grant",
    "state": "risk",
    "progress": 48,
    "metric": "4 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final reporting check before the handoff can leave review.",
    "points": [
      22,
      38,
      31,
  ...
  {
    "id": "item-02",
    "title": "CivicGrant exception sweep",
    "owner": "Ana Ito",
    "state": "review",
    "progress": 59,
    "metric": "13 queued",
  ...
  {
    "id": "item-03",
    "title": "Reporting readiness lane",
    "owner": "Caleb Moss",
    "state": "ready",
    "progress": 75,
    "metric": "82% ready",
  ...
  {
    "id": "item-04",
    "title": "CivicGrant owner follow-up",
    "owner": "Eli Stone",
    "state": "risk",
    "progress": 52,
    "metric": "5 handoffs",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Grant Reporting Calendar</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Grant Reporting Calendar command rail">
          ...
          <section className="panel" aria-label="Grant Reporting Calendar queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Grant Reporting Calendar detail inspector">
            <div className="panelHeader">
