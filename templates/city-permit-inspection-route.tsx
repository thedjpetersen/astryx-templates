...
/**
 * @file page.tsx
 * @input Deterministic Curbmark fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Permit Inspection Route: Municipal inspection route board for permits, windows, code flags, travel order, and same-day reassignments.
...
const BRAND = "Curbmark";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Permit priority packet",
    "owner": "Owen Ellis",
    "state": "risk",
    "progress": 78,
    "metric": "4 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final inspection check before the handoff can leave review.",
    "points": [
      22,
      34,
      31,
  ...
  {
    "id": "item-02",
    "title": "Curbmark exception sweep",
    "owner": "Leah Chen",
    "state": "review",
    "progress": 89,
    "metric": "11 queued",
  ...
  {
    "id": "item-03",
    "title": "Inspection readiness lane",
    "owner": "Iris Cole",
    "state": "ready",
    "progress": 99,
    "metric": "75% ready",
  ...
  {
    "id": "item-04",
    "title": "Curbmark owner follow-up",
    "owner": "Drew Patel",
    "state": "risk",
    "progress": 82,
    "metric": "3 handoffs",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Permit Inspection Route command rail">
          ...
          <section className="panel" aria-label="Permit Inspection Route queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Permit Inspection Route detail inspector">
            <div className="panelHeader">
