...
/**
 * @file page.tsx
 * @input Deterministic Clearcase fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Privacy DSAR Intake: Privacy request intake board for identity proof, system searches, redaction tasks, and statutory clocks.
...
const BRAND = "Clearcase";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Privacy priority packet",
    "owner": "Mina Park",
    "state": "risk",
    "progress": 78,
    "metric": "5 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final dsar check before the handoff can leave review.",
    "points": [
      22,
      38,
      31,
  ...
  {
    "id": "item-02",
    "title": "Clearcase exception sweep",
    "owner": "Sam Rivera",
    "state": "review",
    "progress": 89,
    "metric": "10 queued",
  ...
  {
    "id": "item-04",
    "title": "Clearcase owner follow-up",
    "owner": "Maya Fox",
    "state": "review",
    "progress": 82,
    "metric": "2 handoffs",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Privacy DSAR Intake command rail">
          ...
          <section className="panel" aria-label="Privacy DSAR Intake queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Privacy DSAR Intake detail inspector">
            <div className="panelHeader">
