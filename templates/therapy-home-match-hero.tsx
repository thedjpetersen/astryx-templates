...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Therapy Home Match Hero. No Date.now(),
 ...
 * @output Therapy Home Match Hero: Therapy website experience for a warm therapist-matching homepage, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for new clients comparing therapy options. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template therapy-home-match-hero`
 *
...
const SCOPE = "tpl-therapy-home-match-hero";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Discovery",
  title: "Therapy Home Match Hero",
  focus: "a warm therapist-matching homepage",
  audience: "new clients comparing therapy options",
  primary: "Start matching",
  secondary: "Browse therapists",
  metric: "3 min",
  metricLabel: "guided match",
  metricCaption: "Seven plain-language questions route visitors to available clinicians.",
  searchPlaceholder: "Search virtual and in-person, licensed therapists, or insurance-aware",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what new clients comparing therapy options need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Start matching",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a warm therapist-matching homepage.",
    "metric": "3 min",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after start matching, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "virtual and in-person",
    "detail": "Visitors can understand a warm therapist-matching homepage without reading dense clinical copy."
  },
  {
    "label": "Check fit",
  ...
  },
  {
    ...
    "value": "insurance-aware",
    "detail": "Scheduling, payment, consent, and support paths stay close to the main decision."
  },
  {
    "label": "Begin care",
    "value": "3 min",
    "detail": "Seven plain-language questions route visitors to available clinicians."
  }
];
const RESOURCES = [
  "Discovery guide",
...
export default function TherapyHomeMatchHero() {
