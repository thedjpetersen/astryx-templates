...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Therapist Credentialing. No Date.now(),
 ...
 * @output Therapist Credentialing: Therapy website experience for a therapist onboarding and credentialing tracker, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for practice teams bringing new clinicians online. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template therapist-onboarding-credentialing`
 *
...
const SCOPE = "tpl-therapist-onboarding-credentialing";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Practice Ops",
  title: "Therapist Credentialing",
  focus: "a therapist onboarding and credentialing tracker",
  audience: "practice teams bringing new clinicians online",
  primary: "Review packet",
  secondary: "Request document",
  metric: "91%",
  metricLabel: "credentialed",
  metricCaption: "License, payer, training, profile, and launch tasks are sequenced clearly.",
  searchPlaceholder: "Search license, payer, or launch",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what practice teams bringing new clinicians online need before they commit, then keeps the next action obvious and low-pressure.",
  ...
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for a therapist onboarding and credentialing tracker.",
    "metric": "91%",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after review packet, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "license",
    "detail": "Visitors can understand a therapist onboarding and credentialing tracker without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "payer",
  ...
  },
  {
    "label": "Begin care",
    "value": "91%",
    "detail": "License, payer, training, profile, and launch tasks are sequenced clearly."
  }
];
const RESOURCES = [
  "Practice Ops guide",
...
export default function TherapistOnboardingCredentialing() {
