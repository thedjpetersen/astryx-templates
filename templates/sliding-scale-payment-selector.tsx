...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Sliding Scale Selector. No Date.now(),
 ...
 * @output Sliding Scale Selector: Therapy website experience for a sliding-scale payment selector, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients choosing affordable therapy payment options. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template sliding-scale-payment-selector`
 *
...
const SCOPE = "tpl-sliding-scale-payment-selector";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Billing",
  title: "Sliding Scale Selector",
  focus: "a sliding-scale payment selector",
  audience: "clients choosing affordable therapy payment options",
  primary: "Choose rate",
  secondary: "Request review",
  metric: "$65",
  metricLabel: "lowest rate",
  metricCaption: "Payment options, eligibility notes, and dignity-preserving copy are grouped.",
  searchPlaceholder: "Search sliding scale, self-pay, or equity",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients choosing affordable therapy payment options need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Choose rate",
    "icon": "search",
    "tone": "mint"
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for a sliding-scale payment selector.",
    "metric": "$65",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after choose rate, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "sliding scale",
    "detail": "Visitors can understand a sliding-scale payment selector without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "self-pay",
  ...
  },
  {
    "label": "Begin care",
    "value": "$65",
    "detail": "Payment options, eligibility notes, and dignity-preserving copy are grouped."
  }
];
const RESOURCES = [
  "Billing guide",
...
export default function SlidingScalePaymentSelector() {
