...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Grief Support Group Page. No Date.now(),
 ...
 * @output Grief Support Group Page: Therapy website experience for a grief support group page, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients considering group support after loss. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template grief-support-group-page`
 *
...
const SCOPE = "tpl-grief-support-group-page";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Specialty Care",
  title: "Grief Support Group Page",
  focus: "a grief support group page",
  audience: "clients considering group support after loss",
  primary: "Join group",
  secondary: "Ask facilitator",
  metric: "10",
  metricLabel: "group spots",
  metricCaption: "The page sets expectations around pacing, facilitator role, privacy, and attendance.",
  searchPlaceholder: "Search grief, group, or facilitator",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients considering group support after loss need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Join group",
    "icon": "search",
    "tone": "mint"
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for a grief support group page.",
    "metric": "10",
    "icon": "shield",
    "tone": "blue"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "grief",
    "detail": "Visitors can understand a grief support group page without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "group",
  ...
  },
  {
    "label": "Begin care",
    "value": "10",
    "detail": "The page sets expectations around pacing, facilitator role, privacy, and attendance."
  }
];
const RESOURCES = [
...
export default function GriefSupportGroupPage() {
