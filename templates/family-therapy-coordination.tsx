...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Family Therapy Coordination. No Date.now(),
 ...
 * @output Family Therapy Coordination: Therapy website experience for a family therapy coordination hub, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for families coordinating participants, consent, and session logistics. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template family-therapy-coordination`
 *
...
const SCOPE = "tpl-family-therapy-coordination";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Specialty Care",
  title: "Family Therapy Coordination",
  focus: "a family therapy coordination hub",
  audience: "families coordinating participants, consent, and session logistics",
  primary: "Coordinate session",
  secondary: "Add participant",
  metric: "5",
  metricLabel: "family members",
  metricCaption: "The hub separates guardians, dependents, releases, and scheduling needs.",
  searchPlaceholder: "Search family, consent, or roles",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what families coordinating participants, consent, and session logistics need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Coordinate session",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a family therapy coordination hub.",
    "metric": "5",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after coordinate session, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "family",
    "detail": "Visitors can understand a family therapy coordination hub without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "consent",
  ...
  },
  {
    "label": "Begin care",
    "value": "5",
    "detail": "The hub separates guardians, dependents, releases, and scheduling needs."
  }
];
const RESOURCES = [
...
export default function FamilyTherapyCoordination() {
