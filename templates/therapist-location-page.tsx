...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Therapist Location Page. No Date.now(),
 ...
 * @output Therapist Location Page: Therapy website experience for a local therapy location page, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients searching for therapy near a city or neighborhood. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template therapist-location-page`
 *
...
const SCOPE = "tpl-therapist-location-page";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Discovery",
  title: "Therapist Location Page",
  focus: "a local therapy location page",
  audience: "clients searching for therapy near a city or neighborhood",
  primary: "Find local care",
  secondary: "See map",
  metric: "11",
  metricLabel: "nearby clinicians",
  metricCaption: "Local trust signals, office logistics, accessibility, and virtual alternatives are balanced.",
  searchPlaceholder: "Search local care, office, or accessibility",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients searching for therapy near a city or neighborhood need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Find local care",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a local therapy location page.",
    "metric": "11",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after find local care, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "local care",
    "detail": "Visitors can understand a local therapy location page without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "office",
  ...
  },
  {
    "label": "Begin care",
    "value": "11",
    "detail": "Local trust signals, office logistics, accessibility, and virtual alternatives are balanced."
  }
];
const RESOURCES = [
  "Discovery guide",
...
export default function TherapistLocationPage() {
