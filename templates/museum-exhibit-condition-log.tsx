...
/**
 * @file page.tsx
 * @input Deterministic Curio fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Exhibit Condition Log: Museum object-condition surface for gallery checks, humidity excursions, conservation notes, and movement approvals.
 * @position Page template; emitted by `astryx template museum-exhibit-condition-log`
 *
...
const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Exhibit priority packet",
    "owner": "Mina Park",
    "state": "risk",
    "progress": 63,
    "metric": "4 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final condition check before the handoff can leave review.",
    "points": [
      22,
      36,
      31,
  ...
  {
    "id": "item-03",
    "title": "Condition readiness lane",
    "owner": "June Kim",
    "state": "ready",
    "progress": 90,
    "metric": "87% ready",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Exhibit Condition Log command rail">
          ...
          <section className="panel" aria-label="Exhibit Condition Log queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Exhibit Condition Log detail inspector">
            <div className="panelHeader">
