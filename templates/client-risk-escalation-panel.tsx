...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Client Risk Escalation Panel. No Date.now(),
 ...
 * @output Client Risk Escalation Panel: Therapy website experience for a client risk escalation panel, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clinical teams responding to elevated-risk client signals. The primary and secondary CTAs
 ...
 * @position Page template; emitted by `astryx template client-risk-escalation-panel`
 *
...
const SCOPE = "tpl-client-risk-escalation-panel";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Safety",
  title: "Client Risk Escalation Panel",
  focus: "a client risk escalation panel",
  audience: "clinical teams responding to elevated-risk client signals",
  primary: "Escalate case",
  secondary: "Review plan",
  metric: "4",
  metricLabel: "active flags",
  metricCaption: "Risk notes, safety plan status, contacts, and next steps are kept separate from routine care.",
  searchPlaceholder: "Search safety, risk, or handoff",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clinical teams responding to elevated-risk client signals need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Escalate case",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a client risk escalation panel.",
    "metric": "4",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after escalate case, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "safety",
    "detail": "Visitors can understand a client risk escalation panel without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "risk",
  ...
  },
  {
    "label": "Begin care",
    "value": "4",
    "detail": "Risk notes, safety plan status, contacts, and next steps are kept separate from routine care."
  }
];
const RESOURCES = [
  "Safety guide",
...
export default function ClientRiskEscalationPanel() {
