...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Journal Prompt Card. No Date.now(),
 ...
 * @output Journal Prompt Card: Therapy website experience for a guided therapy journal prompt component, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients reflecting after sessions or during skills practice. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template therapy-journal-prompt-card\`
 *
...
const SCOPE = "tpl-therapy-journal-prompt-card";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Care Delivery",
  title: "Journal Prompt Card",
  focus: "a guided therapy journal prompt component",
  audience: "clients reflecting after sessions or during skills practice",
  primary: "Start writing",
  secondary: "Pick prompt",
  metric: "12",
  metricLabel: "prompt deck",
  metricCaption: "Prompts provide structure while preserving privacy and client control.",
  searchPlaceholder: "Search reflection, CBT, or values",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients reflecting after sessions or during skills practice need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Start writing",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a guided therapy journal prompt component.",
    "metric": "12",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after start writing, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "reflection",
    "detail": "Visitors can understand a guided therapy journal prompt component without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "CBT",
  ...
  },
  {
    "label": "Begin care",
    "value": "12",
    "detail": "Prompts provide structure while preserving privacy and client control."
  }
];
const RESOURCES = [
  "Care Delivery guide",
...
export default function TherapyJournalPromptCard() {
