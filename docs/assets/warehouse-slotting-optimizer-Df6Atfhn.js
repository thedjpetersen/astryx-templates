...
/**
 * @file page.tsx
 * @input Deterministic Pickpath fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Warehouse Slotting Optimizer: Slotting planner that ranks SKUs by velocity, cube, pick path strain, and move-window readiness.
...
const SCOPE = "tpl-warehouse-slotting-optimizer";
const BRAND = "Pickpath";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Warehouse priority packet",
    "owner": "Mina Park",
    "state": "risk",
    "progress": 54,
    "metric": "7 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final slotting check before the handoff can leave review.",
    "points": [
      22,
      37,
      31,
  ...
  {
    "id": "item-02",
    "title": "Pickpath exception sweep",
    "owner": "Sam Rivera",
    "state": "review",
    "progress": 65,
    "metric": "8 queued",
  ...
  {
    "id": "item-04",
    "title": "Pickpath owner follow-up",
    "owner": "Maya Fox",
    "state": "review",
    "progress": 58,
    "metric": "2 handoffs",
  ...
  {
    "id": "item-05",
    "title": "Warehouse signed-off path",
    "owner": "Nia Flores",
    "state": "ready",
    "progress": 89,
    "metric": "18 artifacts",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              <p className="eyebrow">{BRAND} / Logistics</p>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Warehouse Slotting Optimizer command rail">
          ...
          <section className="panel" aria-label="Warehouse Slotting Optimizer queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Warehouse Slotting Optimizer detail inspector">
            <div className="panelHeader">
