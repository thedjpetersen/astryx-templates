...
const RESOLUTION = {
  ...
  note: 'Redline accepted in\xA0v5\xA0·\xA0Jul\xA013',
...
const CAPTIONS = {
  high: {
    ...
    note: 'Red-washed carve-out with the full margin flag card — severity, rationale, citations, playbook position, acknowledge\xA0/\xA0escalate.',
  },
  resolved: {
    stateId: '02 · resolved',
