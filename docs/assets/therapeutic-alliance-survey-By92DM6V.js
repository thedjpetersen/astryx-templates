...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Alliance Survey. No Date.now(),
 ...
 * @output Alliance Survey: Therapy website experience for a therapeutic alliance feedback survey, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients sharing fit and collaboration feedback safely. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template therapeutic-alliance-survey\`
 *
...
const SCOPE = "tpl-therapeutic-alliance-survey";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Care Delivery",
  title: "Alliance Survey",
  focus: "a therapeutic alliance feedback survey",
  audience: "clients sharing fit and collaboration feedback safely",
  primary: "Submit feedback",
  secondary: "Review themes",
  metric: "4.8",
  metricLabel: "alliance score",
  metricCaption: "The survey frames feedback around safety, goals, pacing, and cultural fit.",
  searchPlaceholder: "Search feedback, fit, or trust",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients sharing fit and collaboration feedback safely need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Submit feedback",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a therapeutic alliance feedback survey.",
    "metric": "4.8",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after submit feedback, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "feedback",
    "detail": "Visitors can understand a therapeutic alliance feedback survey without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "fit",
  ...
  },
  {
    "label": "Begin care",
    "value": "4.8",
    "detail": "The survey frames feedback around safety, goals, pacing, and cultural fit."
  }
];
const RESOURCES = [
  "Care Delivery guide",
...
export default function TherapeuticAllianceSurvey() {
