...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Therapist Profile Longform. No Date.now(),
 ...
 * @output Therapist Profile Longform: Therapy website experience for a detailed clinician profile page, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients deciding whether a therapist feels clinically and personally aligned. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template therapist-profile-longform\`
 *
...
const SCOPE = "tpl-therapist-profile-longform";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Discovery",
  title: "Therapist Profile Longform",
  focus: "a detailed clinician profile page",
  audience: "clients deciding whether a therapist feels clinically and personally aligned",
  primary: "Request consult",
  secondary: "Share profile",
  metric: "96%",
  metricLabel: "profile complete",
  metricCaption: "Bio, specialties, session style, credentials, and logistics stay scannable.",
  searchPlaceholder: "Search licensed in NY, CBT and ACT, or evening slots",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients deciding whether a therapist feels clinically and personally aligned need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Request consult",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a detailed clinician profile page.",
    "metric": "96%",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after request consult, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "licensed in NY",
    "detail": "Visitors can understand a detailed clinician profile page without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "CBT and ACT",
  ...
  },
  {
    "label": "Begin care",
    "value": "96%",
    "detail": "Bio, specialties, session style, credentials, and logistics stay scannable."
  }
];
const RESOURCES = [
  "Discovery guide",
...
export default function TherapistProfileLongform() {
