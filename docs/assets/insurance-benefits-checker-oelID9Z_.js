...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Insurance Benefits Checker. No Date.now(),
 ...
 * @output Insurance Benefits Checker: Therapy website experience for an insurance and benefits eligibility checker, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients trying to understand cost before booking therapy. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template insurance-benefits-checker\`
 *
...
const SCOPE = "tpl-insurance-benefits-checker";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Access",
  title: "Insurance Benefits Checker",
  focus: "an insurance and benefits eligibility checker",
  audience: "clients trying to understand cost before booking therapy",
  primary: "Check benefits",
  secondary: "Estimate self-pay",
  metric: "$24",
  metricLabel: "estimated copay",
  metricCaption: "Coverage status, deductible progress, and next documents are shown without jargon.",
  searchPlaceholder: "Search PPO, deductible, or out-of-network",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients trying to understand cost before booking therapy need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Check benefits",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for an insurance and benefits eligibility checker.",
    "metric": "$24",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after check benefits, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "PPO",
    "detail": "Visitors can understand an insurance and benefits eligibility checker without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "deductible",
  ...
  },
  {
    "label": "Begin care",
    "value": "$24",
    "detail": "Coverage status, deductible progress, and next documents are shown without jargon."
  }
];
const RESOURCES = [
  "Access guide",
...
export default function InsuranceBenefitsChecker() {
