...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Outcome Measures Library. No Date.now(),
 ...
 * @output Outcome Measures Library: Therapy website experience for a clinical outcome measures library, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for therapists assigning validated screeners and tracking progress. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template outcome-measures-library\`
 *
...
const SCOPE = "tpl-outcome-measures-library";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Clinical Tools",
  title: "Outcome Measures Library",
  focus: "a clinical outcome measures library",
  audience: "therapists assigning validated screeners and tracking progress",
  primary: "Assign measure",
  secondary: "Compare scores",
  metric: "9",
  metricLabel: "measures",
  metricCaption: "Screeners, cadence, scoring, and client-facing explanations sit in one place.",
  searchPlaceholder: "Search PHQ-9, GAD-7, or progress",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what therapists assigning validated screeners and tracking progress need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Assign measure",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a clinical outcome measures library.",
    "metric": "9",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after assign measure, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "PHQ-9",
    "detail": "Visitors can understand a clinical outcome measures library without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "GAD-7",
  ...
  },
  {
    "label": "Begin care",
    "value": "9",
    "detail": "Screeners, cadence, scoring, and client-facing explanations sit in one place."
  }
];
const RESOURCES = [
...
export default function OutcomeMeasuresLibrary() {
