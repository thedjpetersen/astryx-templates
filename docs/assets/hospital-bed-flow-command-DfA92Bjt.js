...
/**
 * @file page.tsx
 * @input Deterministic Bedline fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Hospital Bed Flow Command: Bed management command surface for pending admits, isolation requirements, discharge blockers, and unit-level capacity.
...
const SCOPE = "tpl-hospital-bed-flow-command";
const BRAND = "Bedline";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Hospital priority packet",
    "owner": "Riya Shah",
    "state": "risk",
    "progress": 54,
    "metric": "5 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final bed check before the handoff can leave review.",
    "points": [
      22,
      36,
      31,
  ...
  {
    "id": "item-05",
    "title": "Hospital signed-off path",
    "owner": "Hana Roy",
    "state": "ready",
    "progress": 89,
    "metric": "14 artifacts",
...
export default function HospitalBedFlowCommandTemplate() {
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Hospital Bed Flow Command</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Hospital Bed Flow Command command rail">
          ...
          <section className="panel" aria-label="Hospital Bed Flow Command queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Hospital Bed Flow Command detail inspector">
            <div className="panelHeader">
