...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Clinical Fit Quiz. No Date.now(),
 ...
 * @output Clinical Fit Quiz: Therapy website experience for a clinical fit quiz experience, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients describing preferences, goals, and care constraints. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template clinical-fit-quiz\`
 *
...
const SCOPE = "tpl-clinical-fit-quiz";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Discovery",
  title: "Clinical Fit Quiz",
  focus: "a clinical fit quiz experience",
  audience: "clients describing preferences, goals, and care constraints",
  primary: "Take quiz",
  secondary: "Skip to search",
  metric: "7",
  metricLabel: "questions",
  metricCaption: "The quiz uses low-pressure language and makes skip paths visible.",
  searchPlaceholder: "Search quiz, preferences, or matching",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients describing preferences, goals, and care constraints need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Take quiz",
    "icon": "search",
    "tone": "mint"
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for a clinical fit quiz experience.",
    "metric": "7",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after take quiz, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "quiz",
    "detail": "Visitors can understand a clinical fit quiz experience without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "preferences",
  ...
  },
  {
    "label": "Begin care",
    "value": "7",
    "detail": "The quiz uses low-pressure language and makes skip paths visible."
  }
];
const RESOURCES = [
  "Discovery guide",
...
export default function ClinicalFitQuiz() {
