...
/**
 * @file page.tsx
 * @input Deterministic Harborplan fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Port Berth Planner: Marine berth planner for vessel ETAs, crane assignments, tide limits, yard pressure, and delay recovery.
...
const BRAND = "Harborplan";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Port priority packet",
    "owner": "Theo Grant",
    "state": "risk",
    "progress": 63,
    "metric": "5 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final berth check before the handoff can leave review.",
    "points": [
      22,
      40,
      31,
  ...
  {
    "id": "item-02",
    "title": "Harborplan exception sweep",
    "owner": "Ana Ito",
    "state": "review",
    "progress": 74,
    "metric": "11 queued",
  ...
  {
    "id": "item-04",
    "title": "Harborplan owner follow-up",
    "owner": "Eli Stone",
    "state": "risk",
    "progress": 67,
    "metric": "5 handoffs",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Port Berth Planner command rail">
          ...
          <section className="panel" aria-label="Port Berth Planner queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Port Berth Planner detail inspector">
            <div className="panelHeader">
