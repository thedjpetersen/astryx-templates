...
/**
 * @file page.tsx
 * @input Deterministic Frostline fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Cold Chain Excursion Console: Cold-chain exception desk for sensor excursions, product disposition, lane risk, and QA signoff.
...
const SCOPE = "tpl-cold-chain-excursion-console";
const BRAND = "Frostline";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Cold priority packet",
    "owner": "Owen Ellis",
    "state": "risk",
    "progress": 57,
    "metric": "3 blockers",
  ...
  {
    "id": "item-02",
    "title": "Frostline exception sweep",
    "owner": "Leah Chen",
    "state": "review",
    "progress": 68,
    "metric": "9 queued",
  ...
  {
    "id": "item-04",
    "title": "Frostline owner follow-up",
    "owner": "Drew Patel",
    "state": "risk",
    "progress": 61,
    "metric": "3 handoffs",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Cold Chain Excursion Console</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Cold Chain Excursion Console command rail">
          ...
          <section className="panel" aria-label="Cold Chain Excursion Console queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Cold Chain Excursion Console detail inspector">
            <div className="panelHeader">
