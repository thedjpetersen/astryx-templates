...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Review Moderation. No Date.now(),
 ...
 * @output Review Moderation: Therapy website experience for a therapist testimonial moderation queue, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for practice teams reviewing client-facing testimonials and safety constraints. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template therapist-review-moderation\`
 *
...
const SCOPE = "tpl-therapist-review-moderation";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Trust",
  title: "Review Moderation",
  focus: "a therapist testimonial moderation queue",
  audience: "practice teams reviewing client-facing testimonials and safety constraints",
  primary: "Review item",
  secondary: "Publish safely",
  metric: "16",
  metricLabel: "pending reviews",
  metricCaption: "Moderation keeps identity, clinical claims, and consent boundaries explicit.",
  searchPlaceholder: "Search reviews, consent, or moderation",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what practice teams reviewing client-facing testimonials and safety constraints need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Review item",
    "icon": "search",
    "tone": "mint"
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for a therapist testimonial moderation queue.",
    "metric": "16",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after review item, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "reviews",
    "detail": "Visitors can understand a therapist testimonial moderation queue without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "consent",
  ...
  },
  {
    "label": "Begin care",
    "value": "16",
    "detail": "Moderation keeps identity, clinical claims, and consent boundaries explicit."
  }
];
const RESOURCES = [
  "Trust guide",
...
export default function TherapistReviewModeration() {
