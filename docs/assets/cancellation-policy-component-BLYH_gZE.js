...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Cancellation Policy Component. No Date.now(),
 ...
 * @output Cancellation Policy Component: Therapy website experience for a cancellation and late-change policy component, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients reviewing session policies before booking. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template cancellation-policy-component\`
 *
...
const SCOPE = "tpl-cancellation-policy-component";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Trust",
  title: "Cancellation Policy Component",
  focus: "a cancellation and late-change policy component",
  audience: "clients reviewing session policies before booking",
  primary: "Acknowledge policy",
  secondary: "Ask question",
  metric: "24 hr",
  metricLabel: "notice window",
  metricCaption: "Policy copy is paired with examples, exceptions, and rescheduling actions.",
  searchPlaceholder: "Search policy, reschedule, or fees",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients reviewing session policies before booking need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Acknowledge policy",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a cancellation and late-change policy component.",
    "metric": "24 hr",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after acknowledge policy, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "policy",
    "detail": "Visitors can understand a cancellation and late-change policy component without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "reschedule",
  ...
  },
  {
    "label": "Begin care",
    "value": "24 hr",
    "detail": "Policy copy is paired with examples, exceptions, and rescheduling actions."
  }
];
const RESOURCES = [
  "Trust guide",
...
export default function CancellationPolicyComponent() {
