...
/**
 * @file page.tsx
 * @input Deterministic Cuegrid fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Theater Rehearsal Grid: Rehearsal scheduling grid with actor conflicts, scene coverage, prop readiness, and room holds.
...
const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Theater priority packet",
    "owner": "Riya Shah",
    "state": "risk",
    "progress": 69,
    "metric": "6 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final rehearsal check before the handoff can leave review.",
    "points": [
      22,
      38,
      31,
  ...
  {
    "id": "item-03",
    "title": "Rehearsal readiness lane",
    "owner": "Priya Nair",
    "state": "ready",
    "progress": 96,
    "metric": "72% ready",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Theater Rehearsal Grid command rail">
          ...
          <section className="panel" aria-label="Theater Rehearsal Grid queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Theater Rehearsal Grid detail inspector">
            <div className="panelHeader">
