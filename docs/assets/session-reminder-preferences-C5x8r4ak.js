...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Reminder Preferences. No Date.now(),
 ...
 * @output Reminder Preferences: Therapy website experience for a therapy session reminder preferences panel, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients configuring reminders without over-sharing sensitive details. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template session-reminder-preferences\`
 *
...
const SCOPE = "tpl-session-reminder-preferences";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Scheduling",
  title: "Reminder Preferences",
  focus: "a therapy session reminder preferences panel",
  audience: "clients configuring reminders without over-sharing sensitive details",
  primary: "Save reminders",
  secondary: "Preview message",
  metric: "3",
  metricLabel: "channels",
  metricCaption: "SMS, email, and push reminders show privacy wording before opt-in.",
  searchPlaceholder: "Search SMS, email, or privacy",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients configuring reminders without over-sharing sensitive details need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Save reminders",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a therapy session reminder preferences panel.",
    "metric": "3",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after save reminders, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "SMS",
    "detail": "Visitors can understand a therapy session reminder preferences panel without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "email",
  ...
  },
  {
    "label": "Begin care",
    "value": "3",
    "detail": "SMS, email, and push reminders show privacy wording before opt-in."
  }
];
const RESOURCES = [
  "Scheduling guide",
...
export default function SessionReminderPreferences() {
