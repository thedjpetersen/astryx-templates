...
/**
 * @file page.tsx
 * @input Deterministic Floatdesk fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Treasury Cash Position: Daily treasury surface for entity cash, sweeps, settlement windows, trapped balances, and funding actions.
...
const SCOPE = "tpl-treasury-cash-position";
const BRAND = "Floatdesk";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Treasury priority packet",
    "owner": "Theo Grant",
    "state": "risk",
    "progress": 69,
    "metric": "5 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final cash check before the handoff can leave review.",
    "points": [
      22,
      34,
      31,
  ...
  {
    "id": "item-02",
    "title": "Floatdesk exception sweep",
    "owner": "Ana Ito",
    "state": "review",
    "progress": 80,
    "metric": "9 queued",
  ...
  {
    "id": "item-04",
    "title": "Floatdesk owner follow-up",
    "owner": "Eli Stone",
    "state": "risk",
    "progress": 73,
    "metric": "5 handoffs",
  ...
  {
    "id": "item-05",
    "title": "Treasury signed-off path",
    "owner": "Jon Bell",
    "state": "ready",
    "progress": 100,
    "metric": "19 artifacts",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Treasury Cash Position command rail">
          ...
          <section className="panel" aria-label="Treasury Cash Position queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Treasury Cash Position detail inspector">
            <div className="panelHeader">
