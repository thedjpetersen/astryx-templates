...
export default function MobilePartyHeadcountGridTemplate() {
  ...
  const sheetGuestId = state.sheet?.kind === 'guest' ? state.sheet.guestId : null;
  const sheetGuest = sheetGuestId == null ? null : state.guests.find(g => g.id === sheetGuestId) ?? null;
              ...
              <div style={styles.countStrip}>
                ...
                <button
                  ...
                  <span style={styles.nudgeChip}>
                    <Icon icon={BellRingIcon} size="xsm" color="inherit" />
