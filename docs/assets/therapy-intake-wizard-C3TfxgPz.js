...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Therapy Intake Wizard. No Date.now(),
 ...
 * @output Therapy Intake Wizard: Therapy website experience for a pre-visit intake flow, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for new clients completing clinical, consent, and logistics questions. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template therapy-intake-wizard\`
 *
...
const SCOPE = "tpl-therapy-intake-wizard";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Onboarding",
  title: "Therapy Intake Wizard",
  focus: "a pre-visit intake flow",
  audience: "new clients completing clinical, consent, and logistics questions",
  primary: "Continue intake",
  secondary: "Save for later",
  metric: "82%",
  metricLabel: "complete",
  metricCaption: "The wizard separates sensitive care context from administrative details.",
  searchPlaceholder: "Search symptoms, goals, or consent",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what new clients completing clinical, consent, and logistics questions need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Continue intake",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a pre-visit intake flow.",
    "metric": "82%",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after continue intake, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "symptoms",
    "detail": "Visitors can understand a pre-visit intake flow without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "goals",
  ...
  },
  {
    "label": "Begin care",
    "value": "82%",
    "detail": "The wizard separates sensitive care context from administrative details."
  }
];
const RESOURCES = [
  "Onboarding guide",
...
export default function TherapyIntakeWizard() {
