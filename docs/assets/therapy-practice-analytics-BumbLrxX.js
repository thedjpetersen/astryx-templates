...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Practice Analytics. No Date.now(),
 ...
 * @output Practice Analytics: Therapy website experience for a therapy practice analytics dashboard, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for practice leaders monitoring access, retention, and clinical operations. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template therapy-practice-analytics\`
 *
...
const SCOPE = "tpl-therapy-practice-analytics";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Practice Ops",
  title: "Practice Analytics",
  focus: "a therapy practice analytics dashboard",
  audience: "practice leaders monitoring access, retention, and clinical operations",
  primary: "Review trends",
  secondary: "Export report",
  metric: "86%",
  metricLabel: "kept visits",
  metricCaption: "Access, utilization, outcomes, cancellations, and payment trends stay connected.",
  searchPlaceholder: "Search retention, access, or outcomes",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what practice leaders monitoring access, retention, and clinical operations need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Review trends",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a therapy practice analytics dashboard.",
    "metric": "86%",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after review trends, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "retention",
    "detail": "Visitors can understand a therapy practice analytics dashboard without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "access",
  ...
  },
  {
    "label": "Begin care",
    "value": "86%",
    "detail": "Access, utilization, outcomes, cancellations, and payment trends stay connected."
  }
];
const RESOURCES = [
  "Practice Ops guide",
...
export default function TherapyPracticeAnalytics() {
