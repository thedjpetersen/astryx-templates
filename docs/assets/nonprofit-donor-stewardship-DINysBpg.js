...
/**
 * @file page.tsx
 * @input Deterministic Kindred fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Donor Stewardship Desk: Relationship desk for major gifts, pledge risk, acknowledgement status, next-best touch, and campaign coverage.
...
const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Donor priority packet",
    "owner": "Mina Park",
    "state": "risk",
    "progress": 51,
    "metric": "5 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final stewardship check before the handoff can leave review.",
    "points": [
      22,
      39,
      31,
  ...
  {
    "id": "item-03",
    "title": "Stewardship readiness lane",
    "owner": "June Kim",
    "state": "ready",
    "progress": 78,
    "metric": "83% ready",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Donor Stewardship Desk command rail">
          ...
          <section className="panel" aria-label="Donor Stewardship Desk queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Donor Stewardship Desk detail inspector">
            <div className="panelHeader">
