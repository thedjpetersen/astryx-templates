...
/**
 * @file page.tsx
 * @input Deterministic Bidloom fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Procurement Bid Evaluator: Sourcing evaluation matrix for vendor bids with weighted criteria, exceptions, clarifications, and award readiness.
...
const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Procurement priority packet",
    "owner": "Owen Ellis",
    "state": "risk",
    "progress": 75,
    "metric": "7 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final bid check before the handoff can leave review.",
    "points": [
      22,
      36,
      31,
  ...
  {
    "id": "item-05",
    "title": "Procurement signed-off path",
    "owner": "Marcus Lee",
    "state": "ready",
    "progress": 100,
    "metric": "12 artifacts",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Procurement Bid Evaluator</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Procurement Bid Evaluator command rail">
          ...
          <section className="panel" aria-label="Procurement Bid Evaluator queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Procurement Bid Evaluator detail inspector">
            <div className="panelHeader">
