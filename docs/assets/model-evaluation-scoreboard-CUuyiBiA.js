import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{n as t,t as n}from"./jsx-runtime-CIxEorsV.js";import{t as r}from"./activity-BKy_Ng2O.js";import{t as i}from"./arrow-right-pzF8RJvv.js";import{t as a}from"./clock-3-Bveyq60I.js";import{t as o}from"./list-checks-BhyN9r1o.js";import{t as s}from"./rotate-ccw-2eDSV2K2.js";import{b as c,d as l,o as u}from"./index-Di_DyBGM.js";import{n as d,t as f}from"./LayoutContent-CCL91W7X.js";import{t as p}from"./LayoutHeader-Cy2mWoMf.js";var m=e(t(),1),h=n(),g=`Evalmark`,_=[{id:`item-01`,title:`Model priority packet`,owner:`Owen Ellis`,state:`risk`,progress:48,metric:`6 blockers`,due:`Today 2:00 PM`,detail:`Needs owner confirmation, evidence refresh, and a final evaluation check before the handoff can leave review.`,points:[22,39,31,48,51,63]},{id:`item-02`,title:`Evalmark exception sweep`,owner:`Leah Chen`,state:`review`,progress:59,metric:`11 queued`,due:`Tomorrow 10:30 AM`,detail:`Combines fresh queue movement with stale exceptions so the detail pane exposes drift instead of hiding it in aggregate totals.`,points:[18,28,44,40,58,70]},{id:`item-03`,title:`Evaluation readiness lane`,owner:`Iris Cole`,state:`ready`,progress:75,metric:`87% ready`,due:`Fri 4:00 PM`,detail:`All required fields reconcile; remaining work is sequencing, stakeholder acknowledgement, and export packaging.`,points:[40,52,58,67,73,86]},{id:`item-04`,title:`Evalmark owner follow-up`,owner:`Drew Patel`,state:`risk`,progress:52,metric:`3 handoffs`,due:`Mon 9:15 AM`,detail:`Long-label stress case: cross-functional ownership remains visible while the row keeps actions and metrics inside fixed hit zones.`,points:[16,21,32,49,51,60]},{id:`item-05`,title:`Model signed-off path`,owner:`Marcus Lee`,state:`ready`,progress:83,metric:`18 artifacts`,due:`Next Tue`,detail:`Serves as the stable control row: derived counts, timeline marks, and the detail chart should not move when filters change.`,points:[44,49,61,68,78,91]}],v=[{label:`Intake`,count:15,tone:`neutral`},{label:`Review`,count:10,tone:`review`},{label:`Blocked`,count:3,tone:`risk`},{label:`Ready`,count:10,tone:`ready`}],y=[{id:`all`,label:`All`},{id:`risk`,label:`At risk`},{id:`review`,label:`Review`},{id:`ready`,label:`Ready`}],b={risk:`At risk`,review:`In review`,ready:`Ready`},x={risk:`review`,review:`ready`,ready:`ready`},S=`
