...
/**
 * @file page.tsx
 * @input Deterministic Cutover fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Implementation Cutover Plan: Launch cutover planner joining data migration, DNS, comms, rollback checkpoints, and go-live signoff.
...
const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Implementation priority packet",
    "owner": "Theo Grant",
    "state": "risk",
    "progress": 66,
    "metric": "7 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final cutover check before the handoff can leave review.",
    "points": [
      22,
      38,
      31,
  ...
  {
    "id": "item-05",
    "title": "Implementation signed-off path",
    "owner": "Jon Bell",
    "state": "ready",
    "progress": 100,
    "metric": "15 artifacts",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              <p className="eyebrow">{BRAND} / SaaS</p>
              <h1>Implementation Cutover Plan</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Implementation Cutover Plan command rail">
          ...
          <section className="panel" aria-label="Implementation Cutover Plan queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Implementation Cutover Plan detail inspector">
            <div className="panelHeader">
