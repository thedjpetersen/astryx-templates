...
/**
 * @file page.tsx
 * @input Deterministic Cohortly fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Feature Adoption Cohort: Product analytics cohort surface showing adoption stages, expansion signals, blockers, and lifecycle actions.
...
const BRAND = "Cohortly";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Feature priority packet",
    "owner": "Mina Park",
    "state": "risk",
    "progress": 57,
    "metric": "4 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final adoption check before the handoff can leave review.",
    "points": [
      22,
      35,
      31,
  ...
  {
    "id": "item-02",
    "title": "Cohortly exception sweep",
    "owner": "Sam Rivera",
    "state": "review",
    "progress": 68,
    "metric": "8 queued",
  ...
  {
    "id": "item-04",
    "title": "Cohortly owner follow-up",
    "owner": "Maya Fox",
    "state": "review",
    "progress": 61,
    "metric": "2 handoffs",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Feature Adoption Cohort command rail">
          ...
          <section className="panel" aria-label="Feature Adoption Cohort queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Feature Adoption Cohort detail inspector">
            <div className="panelHeader">
