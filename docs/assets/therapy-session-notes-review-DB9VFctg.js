...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Session Notes Review. No Date.now(),
 ...
 * @output Session Notes Review: Therapy website experience for a collaborative session summary review page, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients reviewing takeaways, themes, and follow-up after therapy. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template therapy-session-notes-review\`
 *
...
const SCOPE = "tpl-therapy-session-notes-review";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Care Delivery",
  title: "Session Notes Review",
  focus: "a collaborative session summary review page",
  audience: "clients reviewing takeaways, themes, and follow-up after therapy",
  primary: "Mark reviewed",
  secondary: "Ask follow-up",
  metric: "6",
  metricLabel: "takeaways",
  metricCaption: "Notes are structured around goals, exercises, and next-session prep.",
  searchPlaceholder: "Search summary, homework, or goals",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients reviewing takeaways, themes, and follow-up after therapy need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Mark reviewed",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a collaborative session summary review page.",
    "metric": "6",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after mark reviewed, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "summary",
    "detail": "Visitors can understand a collaborative session summary review page without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "homework",
  ...
  },
  {
    "label": "Begin care",
    "value": "6",
    "detail": "Notes are structured around goals, exercises, and next-session prep."
  }
];
const RESOURCES = [
  "Care Delivery guide",
...
export default function TherapySessionNotesReview() {
