...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Depression Care Pathway. No Date.now(),
 ...
 * @output Depression Care Pathway: Therapy website experience for a depression care pathway overview, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients evaluating therapy options for low mood and motivation. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template depression-care-pathway\`
 *
...
const SCOPE = "tpl-depression-care-pathway";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Program",
  title: "Depression Care Pathway",
  focus: "a depression care pathway overview",
  audience: "clients evaluating therapy options for low mood and motivation",
  primary: "View pathway",
  secondary: "Book consult",
  metric: "10",
  metricLabel: "care checkpoints",
  metricCaption: "The pathway shows activation, support, safety planning, and measurement loops.",
  searchPlaceholder: "Search activation, support, or measures",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients evaluating therapy options for low mood and motivation need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "View pathway",
    "icon": "search",
    "tone": "mint"
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for a depression care pathway overview.",
    "metric": "10",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after view pathway, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "activation",
    "detail": "Visitors can understand a depression care pathway overview without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "support",
  ...
  },
  {
    "label": "Begin care",
    "value": "10",
    "detail": "The pathway shows activation, support, safety planning, and measurement loops."
  }
];
const RESOURCES = [
  "Program guide",
...
export default function DepressionCarePathway() {
