...
/**
 * @file page.tsx
 * @input Deterministic Runway fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Aviation Turnaround Board: Ramp operations command board for gating aircraft turns, crew handoffs, fueling, bags, catering, and maintenance blockers.
...
const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Aviation priority packet",
    "owner": "Mina Park",
    "state": "risk",
    "progress": 48,
    "metric": "3 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final turnaround check before the handoff can leave review.",
    "points": [
      22,
      34,
      31,
  ...
  {
    "id": "item-03",
    "title": "Turnaround readiness lane",
    "owner": "June Kim",
    "state": "ready",
    "progress": 75,
    "metric": "71% ready",
  ...
  {
    "id": "item-05",
    "title": "Aviation signed-off path",
    "owner": "Nia Flores",
    "state": "ready",
    "progress": 83,
    "metric": "12 artifacts",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Aviation Turnaround Board</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Aviation Turnaround Board command rail">
          ...
          <section className="panel" aria-label="Aviation Turnaround Board queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Aviation Turnaround Board detail inspector">
            <div className="panelHeader">
