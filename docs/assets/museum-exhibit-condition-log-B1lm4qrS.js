import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{n as t,t as n}from"./jsx-runtime-CIxEorsV.js";import{t as r}from"./Text-DoyyW0Xq.js";import{t as i}from"./Icon-Cbr2QWU5.js";import{t as a}from"./archive-COGDTU_v.js";import{t as o}from"./clipboard-check-jxjNWrPy.js";import{t as s}from"./droplets-CWBgw31B.js";import{t as c}from"./lock-Dx8eqSSK.js";import{t as l}from"./lock-open-CeKuN5z8.js";import{t as u}from"./truck-ez4Xj2SE.js";import{A as d,o as f,w as p}from"./index-BwFrdgVW.js";import{t as ee}from"./Tooltip-XDRm9Z-w.js";import{n as te,t as ne}from"./LayoutContent-CCL91W7X.js";import{t as re}from"./LayoutHeader-Cy2mWoMf.js";import{t as ie}from"./Heading-CEfXHtdE.js";import{t as m}from"./Button-DdhUiDLb.js";import{t as ae}from"./TextInput-Bs7bG3J7.js";import{t as oe}from"./Avatar-DyaNw-yT.js";var h=d(`brush`,[[`path`,{d:`m11 10 3 3`,key:`fzmg1i`}],[`path`,{d:`M6.5 21A3.5 3.5 0 1 0 3 17.5a2.62 2.62 0 0 1-.708 1.792A1 1 0 0 0 3 21z`,key:`p4q2r7`}],[`path`,{d:`M9.969 17.031 21.378 5.624a1 1 0 0 0-3.002-3.002L6.967 14.031`,key:`wy6l02`}]]),g=e(t(),1),_=n(),v=`tpl-museum-exhibit-condition-log`,y=`light-dark(#7C2437, #E58BA0)`,b=`light-dark(rgba(124, 36, 55, 0.08), rgba(229, 139, 160, 0.14))`,x=`light-dark(#15803D, #4ADE80)`,S=`light-dark(rgba(21, 128, 61, 0.10), rgba(74, 222, 128, 0.14))`,C=`light-dark(#1D4ED8, #93C5FD)`,w=`light-dark(rgba(29, 78, 216, 0.09), rgba(147, 197, 253, 0.14))`,T=`light-dark(#B45309, #FBBF24)`,E=`light-dark(rgba(180, 83, 9, 0.10), rgba(251, 191, 36, 0.14))`,D=`light-dark(#B91C1C, #F87171)`,O=`light-dark(rgba(185, 28, 28, 0.10), rgba(248, 113, 113, 0.14))`,k=`light-dark(#0E7490, #22D3EE)`,A=`light-dark(rgba(14, 116, 144, 0.10), rgba(34, 211, 238, 0.14))`,se=`light-dark(rgba(185, 28, 28, 0.22), rgba(248, 113, 113, 0.26))`,j=`light-dark(rgba(60, 60, 67, 0.16), rgba(235, 235, 245, 0.18))`,ce=`light-dark(rgba(21, 128, 61, 0.07), rgba(74, 222, 128, 0.09))`,M=`var(--font-family-code, ui-monospace, monospace)`,le=`
.${v} {
  height: 100dvh;
  width: 100%;
