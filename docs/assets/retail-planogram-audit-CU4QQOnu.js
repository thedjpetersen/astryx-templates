import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{n as t,t as n}from"./jsx-runtime-CIxEorsV.js";import{t as r}from"./activity-B3TDuTjP.js";import{t as i}from"./arrow-right-qErICciv.js";import{t as a}from"./clock-3-T7m7ogV2.js";import{t as o}from"./list-checks-BvUtZmcB.js";import{t as s}from"./rotate-ccw-Dt5cZFDX.js";import{b as c,d as l,o as u}from"./index-Do4FOL-W.js";import{n as d,t as f}from"./LayoutContent-CCL91W7X.js";import{t as p}from"./LayoutHeader-Cy2mWoMf.js";var m=e(t(),1),h=n(),g=`Shelfmark`,_=[{id:`item-01`,title:`Planogram priority packet`,owner:`Mina Park`,state:`risk`,progress:48,metric:`7 blockers`,due:`Today 2:00 PM`,detail:`Needs owner confirmation, evidence refresh, and a final audit check before the handoff can leave review.`,points:[22,36,31,48,53,63]},{id:`item-02`,title:`Shelfmark exception sweep`,owner:`Sam Rivera`,state:`review`,progress:59,metric:`10 queued`,due:`Tomorrow 10:30 AM`,detail:`Combines fresh queue movement with stale exceptions so the detail pane exposes drift instead of hiding it in aggregate totals.`,points:[18,28,44,43,58,70]},{id:`item-03`,title:`Audit readiness lane`,owner:`June Kim`,state:`ready`,progress:75,metric:`81% ready`,due:`Fri 4:00 PM`,detail:`All required fields reconcile; remaining work is sequencing, stakeholder acknowledgement, and export packaging.`,points:[40,52,57,67,73,86]},{id:`item-04`,title:`Shelfmark owner follow-up`,owner:`Maya Fox`,state:`review`,progress:52,metric:`2 handoffs`,due:`Mon 9:15 AM`,detail:`Long-label stress case: cross-functional ownership remains visible while the row keeps actions and metrics inside fixed hit zones.`,points:[16,21,32,50,51,60]},{id:`item-05`,title:`Planogram signed-off path`,owner:`Nia Flores`,state:`ready`,progress:83,metric:`20 artifacts`,due:`Next Tue`,detail:`Serves as the stable control row: derived counts, timeline marks, and the detail chart should not move when filters change.`,points:[44,49,61,65,78,91]}],v=[{label:`Intake`,count:14,tone:`neutral`},{label:`Review`,count:11,tone:`review`},{label:`Blocked`,count:2,tone:`risk`},{label:`Ready`,count:7,tone:`ready`}],y=[{id:`all`,label:`All`},{id:`risk`,label:`At risk`},{id:`review`,label:`Review`},{id:`ready`,label:`Ready`}],b={risk:`At risk`,review:`In review`,ready:`Ready`},x={risk:`review`,review:`ready`,ready:`ready`},S=`
