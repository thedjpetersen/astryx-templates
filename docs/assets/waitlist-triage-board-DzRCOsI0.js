...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Waitlist Triage Board. No Date.now(),
 ...
 * @output Waitlist Triage Board: Therapy website experience for a therapy waitlist triage board, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for care coordinators prioritizing clients waiting for therapist openings. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template waitlist-triage-board\`
 *
...
const SCOPE = "tpl-waitlist-triage-board";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Access",
  title: "Waitlist Triage Board",
  focus: "a therapy waitlist triage board",
  audience: "care coordinators prioritizing clients waiting for therapist openings",
  primary: "Prioritize list",
  secondary: "Offer slot",
  metric: "68",
  metricLabel: "waiting clients",
  metricCaption: "Need, preferences, payer fit, and outreach history guide fair slot offers.",
  searchPlaceholder: "Search waitlist, access, or priority",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what care coordinators prioritizing clients waiting for therapist openings need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Prioritize list",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a therapy waitlist triage board.",
    "metric": "68",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after prioritize list, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "waitlist",
    "detail": "Visitors can understand a therapy waitlist triage board without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "access",
  ...
  },
  {
    "label": "Begin care",
    "value": "68",
    "detail": "Need, preferences, payer fit, and outreach history guide fair slot offers."
  }
];
const RESOURCES = [
  "Access guide",
...
export default function WaitlistTriageBoard() {
