...
/**
 * @file page.tsx
 * @input Deterministic Seatwise fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output SaaS Seat Audit: License optimization console for inactive seats, entitlement drift, reclaim batches, and renewal forecast impact.
...
const SCOPE = "tpl-saas-seat-audit";
const BRAND = "Seatwise";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "SaaS priority packet",
    "owner": "Mina Park",
    "state": "risk",
    "progress": 69,
    "metric": "3 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final seat check before the handoff can leave review.",
    "points": [
      22,
      39,
      31,
  ...
  {
    "id": "item-02",
    "title": "Seatwise exception sweep",
    "owner": "Sam Rivera",
    "state": "review",
    "progress": 80,
    "metric": "12 queued",
  ...
  {
    "id": "item-04",
    "title": "Seatwise owner follow-up",
    "owner": "Maya Fox",
    "state": "review",
    "progress": 73,
    "metric": "2 handoffs",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="SaaS Seat Audit command rail">
          ...
          <section className="panel" aria-label="SaaS Seat Audit queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="SaaS Seat Audit detail inspector">
            <div className="panelHeader">
