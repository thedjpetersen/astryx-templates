...
/**
 * @file page.tsx
 * @input Deterministic Badgepath fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Building Access Review: Physical access review surface for badge groups, orphaned access, manager attestations, and revocation batches.
...
const BRAND = "Badgepath";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Building priority packet",
    "owner": "Riya Shah",
    "state": "risk",
    "progress": 72,
    "metric": "3 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final access check before the handoff can leave review.",
    "points": [
      22,
      36,
      31,
  ...
  {
    "id": "item-02",
    "title": "Badgepath exception sweep",
    "owner": "Noah Brooks",
    "state": "review",
    "progress": 83,
    "metric": "8 queued",
  ...
  {
    "id": "item-04",
    "title": "Badgepath owner follow-up",
    "owner": "Nora Ames",
    "state": "review",
    "progress": 76,
    "metric": "4 handoffs",
  ...
  {
    "id": "item-05",
    "title": "Building signed-off path",
    "owner": "Hana Roy",
    "state": "ready",
    "progress": 100,
    "metric": "15 artifacts",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Building Access Review command rail">
          ...
          <section className="panel" aria-label="Building Access Review queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Building Access Review detail inspector">
            <div className="panelHeader">
