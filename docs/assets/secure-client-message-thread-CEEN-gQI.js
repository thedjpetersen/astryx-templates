...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Secure Client Message Thread. No Date.now(),
 ...
 * @output Secure Client Message Thread: Therapy website experience for a private client-therapist message thread, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients sending care-related updates between sessions. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template secure-client-message-thread\`
 *
...
const SCOPE = "tpl-secure-client-message-thread";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Care Delivery",
  title: "Secure Client Message Thread",
  focus: "a private client-therapist message thread",
  audience: "clients sending care-related updates between sessions",
  primary: "Send update",
  secondary: "Attach note",
  metric: "24 hr",
  metricLabel: "reply target",
  metricCaption: "Boundaries, urgency guidance, and secure delivery state stay visible.",
  searchPlaceholder: "Search secure, non-urgent, or care team",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients sending care-related updates between sessions need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Send update",
    "icon": "search",
    "tone": "mint"
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for a private client-therapist message thread.",
    "metric": "24 hr",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after send update, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "secure",
    "detail": "Visitors can understand a private client-therapist message thread without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "non-urgent",
  ...
  },
  {
    "label": "Begin care",
    "value": "24 hr",
    "detail": "Boundaries, urgency guidance, and secure delivery state stay visible."
  }
];
const RESOURCES = [
  "Care Delivery guide",
...
export default function SecureClientMessageThread() {
