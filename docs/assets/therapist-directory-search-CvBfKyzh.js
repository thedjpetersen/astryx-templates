...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Therapist Directory Search. No Date.now(),
 ...
 * @output Therapist Directory Search: Therapy website experience for a searchable therapist marketplace directory, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients filtering by specialty, identity, budget, and schedule. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template therapist-directory-search\`
 *
...
const SCOPE = "tpl-therapist-directory-search";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Discovery",
  title: "Therapist Directory Search",
  focus: "a searchable therapist marketplace directory",
  audience: "clients filtering by specialty, identity, budget, and schedule",
  primary: "Search therapists",
  secondary: "Save filters",
  metric: "42",
  metricLabel: "open profiles",
  metricCaption: "Every card keeps fit, availability, and payment context visible.",
  searchPlaceholder: "Search anxiety, couples, or sliding scale",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients filtering by specialty, identity, budget, and schedule need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Search therapists",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a searchable therapist marketplace directory.",
    "metric": "42",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after search therapists, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "anxiety",
    "detail": "Visitors can understand a searchable therapist marketplace directory without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "couples",
  ...
  },
  {
    "label": "Begin care",
    "value": "42",
    "detail": "Every card keeps fit, availability, and payment context visible."
  }
];
const RESOURCES = [
  "Discovery guide",
...
export default function TherapistDirectorySearch() {
