...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Therapy Telehealth Lobby. No Date.now(),
 ...
 * @output Therapy Telehealth Lobby: Therapy website experience for a secure telehealth waiting room, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients preparing for a remote therapy appointment. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template therapy-telehealth-lobby\`
 *
...
const SCOPE = "tpl-therapy-telehealth-lobby";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Care Delivery",
  title: "Therapy Telehealth Lobby",
  focus: "a secure telehealth waiting room",
  audience: "clients preparing for a remote therapy appointment",
  primary: "Join session",
  secondary: "Test device",
  metric: "2 min",
  metricLabel: "early arrival",
  metricCaption: "Device checks, privacy reminders, and clinician status share one quiet surface.",
  searchPlaceholder: "Search camera check, private room, or encrypted",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients preparing for a remote therapy appointment need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Join session",
    "icon": "search",
    "tone": "mint"
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for a secure telehealth waiting room.",
    "metric": "2 min",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after join session, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "camera check",
    "detail": "Visitors can understand a secure telehealth waiting room without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "private room",
  ...
  },
  {
    "label": "Begin care",
    "value": "2 min",
    "detail": "Device checks, privacy reminders, and clinician status share one quiet surface."
  }
];
const RESOURCES = [
  "Care Delivery guide",
...
export default function TherapyTelehealthLobby() {
