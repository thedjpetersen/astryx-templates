...
/**
 * @file page.tsx
 * @input Deterministic Signalwatch fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Security Incident War Room: Incident command surface for detections, containment tasks, impacted assets, evidence, and executive status.
...
const BRAND = "Signalwatch";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Security priority packet",
    "owner": "Theo Grant",
    "state": "risk",
    "progress": 75,
    "metric": "4 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final incident check before the handoff can leave review.",
    "points": [
      22,
      37,
      31,
  ...
  {
    "id": "item-02",
    "title": "Signalwatch exception sweep",
    "owner": "Ana Ito",
    "state": "review",
    "progress": 86,
    "metric": "9 queued",
  ...
  {
    "id": "item-04",
    "title": "Signalwatch owner follow-up",
    "owner": "Eli Stone",
    "state": "risk",
    "progress": 79,
    "metric": "5 handoffs",
  ...
  {
    "id": "item-05",
    "title": "Security signed-off path",
    "owner": "Jon Bell",
    "state": "ready",
    "progress": 100,
    "metric": "16 artifacts",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Security Incident War Room</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Security Incident War Room command rail">
          ...
          <section className="panel" aria-label="Security Incident War Room queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Security Incident War Room detail inspector">
            <div className="panelHeader">
