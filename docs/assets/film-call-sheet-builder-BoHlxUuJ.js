import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{n as t,t as n}from"./jsx-runtime-CIxEorsV.js";import{t as r}from"./activity-B3TDuTjP.js";import{t as i}from"./arrow-right-qErICciv.js";import{t as a}from"./clock-3-T7m7ogV2.js";import{t as o}from"./list-checks-BvUtZmcB.js";import{t as s}from"./rotate-ccw-Dt5cZFDX.js";import{b as c,d as l,o as u}from"./index-Do4FOL-W.js";import{n as d,t as f}from"./LayoutContent-CCL91W7X.js";import{t as p}from"./LayoutHeader-Cy2mWoMf.js";var m=e(t(),1),h=n(),g=`Slatewise`,_=[{id:`item-01`,title:`Film priority packet`,owner:`Owen Ellis`,state:`risk`,progress:66,metric:`5 blockers`,due:`Today 2:00 PM`,detail:`Needs owner confirmation, evidence refresh, and a final call check before the handoff can leave review.`,points:[22,37,31,48,53,63]},{id:`item-02`,title:`Slatewise exception sweep`,owner:`Leah Chen`,state:`review`,progress:77,metric:`13 queued`,due:`Tomorrow 10:30 AM`,detail:`Combines fresh queue movement with stale exceptions so the detail pane exposes drift instead of hiding it in aggregate totals.`,points:[18,28,44,40,58,70]},{id:`item-03`,title:`Call readiness lane`,owner:`Iris Cole`,state:`ready`,progress:93,metric:`71% ready`,due:`Fri 4:00 PM`,detail:`All required fields reconcile; remaining work is sequencing, stakeholder acknowledgement, and export packaging.`,points:[40,52,60,67,73,86]},{id:`item-04`,title:`Slatewise owner follow-up`,owner:`Drew Patel`,state:`risk`,progress:70,metric:`3 handoffs`,due:`Mon 9:15 AM`,detail:`Long-label stress case: cross-functional ownership remains visible while the row keeps actions and metrics inside fixed hit zones.`,points:[16,21,32,48,51,60]},{id:`item-05`,title:`Film signed-off path`,owner:`Marcus Lee`,state:`ready`,progress:100,metric:`20 artifacts`,due:`Next Tue`,detail:`Serves as the stable control row: derived counts, timeline marks, and the detail chart should not move when filters change.`,points:[44,49,61,66,78,91]}],v=[{label:`Intake`,count:17,tone:`neutral`},{label:`Review`,count:9,tone:`review`},{label:`Blocked`,count:3,tone:`risk`},{label:`Ready`,count:8,tone:`ready`}],y=[{id:`all`,label:`All`},{id:`risk`,label:`At risk`},{id:`review`,label:`Review`},{id:`ready`,label:`Ready`}],b={risk:`At risk`,review:`In review`,ready:`Ready`},x={risk:`review`,review:`ready`,ready:`ready`},S=`
