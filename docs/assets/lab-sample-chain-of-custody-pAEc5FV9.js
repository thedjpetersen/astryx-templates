...
/**
 * @file page.tsx
 * @input Deterministic Vialpath fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Lab Sample Chain of Custody: Specimen custody console tracking draws, courier handoffs, accessioning, reruns, and exception evidence.
...
const SCOPE = "tpl-lab-sample-chain-of-custody";
const BRAND = "Vialpath";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Sample priority packet",
    "owner": "Theo Grant",
    "state": "risk",
    "progress": 57,
    "metric": "6 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final chain check before the handoff can leave review.",
    "points": [
      22,
      37,
      31,
  ...
  {
    "id": "item-02",
    "title": "Vialpath exception sweep",
    "owner": "Ana Ito",
    "state": "review",
    "progress": 68,
    "metric": "11 queued",
  ...
  {
    "id": "item-04",
    "title": "Vialpath owner follow-up",
    "owner": "Eli Stone",
    "state": "risk",
    "progress": 61,
    "metric": "5 handoffs",
...
export default function LabSampleChainOfCustodyTemplate() {
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Lab Sample Chain of Custody</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Lab Sample Chain of Custody command rail">
          ...
          <section className="panel" aria-label="Lab Sample Chain of Custody queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Lab Sample Chain of Custody detail inspector">
            <div className="panelHeader">
