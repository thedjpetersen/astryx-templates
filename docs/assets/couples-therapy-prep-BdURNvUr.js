...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Couples Therapy Prep. No Date.now(),
 ...
 * @output Couples Therapy Prep: Therapy website experience for a couples therapy preparation flow, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for partners preparing for a first or recurring couples session. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template couples-therapy-prep\`
 *
...
const SCOPE = "tpl-couples-therapy-prep";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Specialty Care",
  title: "Couples Therapy Prep",
  focus: "a couples therapy preparation flow",
  audience: "partners preparing for a first or recurring couples session",
  primary: "Prepare together",
  secondary: "Send invites",
  metric: "2",
  metricLabel: "partner views",
  metricCaption: "Shared and private prompts help partners arrive ready without escalation.",
  searchPlaceholder: "Search partners, conflict, or goals",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what partners preparing for a first or recurring couples session need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Prepare together",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a couples therapy preparation flow.",
    "metric": "2",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after prepare together, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "partners",
    "detail": "Visitors can understand a couples therapy preparation flow without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "conflict",
  ...
  },
  {
    "label": "Begin care",
    "value": "2",
    "detail": "Shared and private prompts help partners arrive ready without escalation."
  }
];
const RESOURCES = [
...
export default function CouplesTherapyPrep() {
