    ...
    <aside
      ...
      <div style={styles.trayHead}>
        ...
        <SegmentedControl
          ...
          <SegmentedControlItem label={\`All\xA0\${allCount}\`} value="all" />
          <SegmentedControlItem label={\`Done\xA0\${completed.length}\`} value="completed" />
          <SegmentedControlItem label={\`In\xA0prog\xA0\${inProgress.length}\`} value="inprogress" />
          <SegmentedControlItem label={\`Xfer\xA0\${transferRows}\`} value="transfer" />
        </SegmentedControl>
      </div>
