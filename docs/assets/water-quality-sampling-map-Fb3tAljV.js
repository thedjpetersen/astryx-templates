...
/**
 * @file page.tsx
 * @input Deterministic Clearwell fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Water Quality Sampling Map: Field sampling control surface for sites, bottles, hold times, chain-of-custody, and lab exceptions.
...
const BRAND = "Clearwell";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Water priority packet",
    "owner": "Riya Shah",
    "state": "risk",
    "progress": 48,
    "metric": "5 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final quality check before the handoff can leave review.",
    "points": [
      22,
      35,
      31,
  ...
  {
    "id": "item-02",
    "title": "Clearwell exception sweep",
    "owner": "Noah Brooks",
    "state": "review",
    "progress": 59,
    "metric": "12 queued",
  ...
  {
    "id": "item-04",
    "title": "Clearwell owner follow-up",
    "owner": "Nora Ames",
    "state": "review",
    "progress": 52,
    "metric": "4 handoffs",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              <p className="eyebrow">{BRAND} / Sustainability</p>
              <h1>Water Quality Sampling Map</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Water Quality Sampling Map command rail">
          ...
          <section className="panel" aria-label="Water Quality Sampling Map queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Water Quality Sampling Map detail inspector">
            <div className="panelHeader">
