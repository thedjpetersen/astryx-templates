...
/**
 * @file page.tsx
 * @input Deterministic Clarity fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Radiology Prior Auth Workbench: Pre-certification workbench for imaging orders with payer rules, clinical notes, denial risk, and slot protection.
...
const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Radiology priority packet",
    "owner": "Owen Ellis",
    "state": "risk",
    "progress": 51,
    "metric": "4 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final prior check before the handoff can leave review.",
    "points": [
      22,
      35,
      31,
  ...
  {
    "id": "item-05",
    "title": "Radiology signed-off path",
    "owner": "Marcus Lee",
    "state": "ready",
    "progress": 86,
    "metric": "13 artifacts",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              <p className="eyebrow">{BRAND} / Healthcare</p>
              <h1>Radiology Prior Auth Workbench</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Radiology Prior Auth Workbench command rail">
          ...
          <section className="panel" aria-label="Radiology Prior Auth Workbench queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Radiology Prior Auth Workbench detail inspector">
            <div className="panelHeader">
