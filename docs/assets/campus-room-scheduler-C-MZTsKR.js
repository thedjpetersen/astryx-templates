...
/**
 * @file page.tsx
 * @input Deterministic Roomsmith fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Campus Room Scheduler: Registrar room scheduler balancing room features, enrollment pressure, accessibility needs, and conflict repair.
...
const BRAND = "Roomsmith";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Campus priority packet",
    "owner": "Owen Ellis",
    "state": "risk",
    "progress": 54,
    "metric": "6 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final room check before the handoff can leave review.",
    "points": [
      22,
      40,
      31,
  ...
  {
    "id": "item-02",
    "title": "Roomsmith exception sweep",
    "owner": "Leah Chen",
    "state": "review",
    "progress": 65,
    "metric": "9 queued",
  ...
  {
    "id": "item-04",
    "title": "Roomsmith owner follow-up",
    "owner": "Drew Patel",
    "state": "risk",
    "progress": 58,
    "metric": "3 handoffs",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Campus Room Scheduler command rail">
          ...
          <section className="panel" aria-label="Campus Room Scheduler queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Campus Room Scheduler detail inspector">
            <div className="panelHeader">
