...
/**
 * @file page.tsx
 * @input Deterministic Sponsorly fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Sponsorship Calendar: Creator campaign calendar balancing deliverables, approvals, exclusivity windows, and payout checkpoints.
 * @position Page template; emitted by \`astryx template creator-sponsorship-calendar\`
 *
...
const BRAND = "Sponsorly";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Sponsorship priority packet",
    "owner": "Theo Grant",
    "state": "risk",
    "progress": 57,
    "metric": "5 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final creator check before the handoff can leave review.",
    "points": [
      22,
      39,
      31,
  ...
  {
    "id": "item-02",
    "title": "Sponsorly exception sweep",
    "owner": "Ana Ito",
    "state": "review",
    "progress": 68,
    "metric": "13 queued",
  ...
  {
    "id": "item-04",
    "title": "Sponsorly owner follow-up",
    "owner": "Eli Stone",
    "state": "risk",
    "progress": 61,
    "metric": "5 handoffs",
  ...
  {
    "id": "item-05",
    "title": "Sponsorship signed-off path",
    "owner": "Jon Bell",
    "state": "ready",
    "progress": 92,
    "metric": "14 artifacts",
...
export default function CreatorSponsorshipCalendarTemplate() {
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              <p className="eyebrow">{BRAND} / Creator</p>
              <h1>Sponsorship Calendar</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Sponsorship Calendar command rail">
          ...
          <section className="panel" aria-label="Sponsorship Calendar queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Sponsorship Calendar detail inspector">
            <div className="panelHeader">
