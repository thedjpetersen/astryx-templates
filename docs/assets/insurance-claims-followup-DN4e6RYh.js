...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Claims Follow-up. No Date.now(),
 ...
 * @output Claims Follow-up: Therapy website experience for an insurance claims follow-up workspace, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients and support teams tracking claim status after therapy visits. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template insurance-claims-followup\`
 *
...
const SCOPE = "tpl-insurance-claims-followup";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Billing",
  title: "Claims Follow-up",
  focus: "an insurance claims follow-up workspace",
  audience: "clients and support teams tracking claim status after therapy visits",
  primary: "Review claim",
  secondary: "Message billing",
  metric: "5",
  metricLabel: "open claims",
  metricCaption: "Claim milestones, missing information, and payer responses become readable.",
  searchPlaceholder: "Search claim, payer, or follow-up",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients and support teams tracking claim status after therapy visits need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Review claim",
    "icon": "search",
    "tone": "mint"
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for an insurance claims follow-up workspace.",
    "metric": "5",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after review claim, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "claim",
    "detail": "Visitors can understand an insurance claims follow-up workspace without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "payer",
  ...
  },
  {
    "label": "Begin care",
    "value": "5",
    "detail": "Claim milestones, missing information, and payer responses become readable."
  }
];
const RESOURCES = [
  "Billing guide",
...
export default function InsuranceClaimsFollowup() {
