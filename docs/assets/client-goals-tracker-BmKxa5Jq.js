...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Client Goals Tracker. No Date.now(),
 ...
 * @output Client Goals Tracker: Therapy website experience for a client progress and goals tracker, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients and therapists checking movement across agreed therapy goals. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template client-goals-tracker\`
 *
...
const SCOPE = "tpl-client-goals-tracker";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Care Delivery",
  title: "Client Goals Tracker",
  focus: "a client progress and goals tracker",
  audience: "clients and therapists checking movement across agreed therapy goals",
  primary: "Update progress",
  secondary: "Review plan",
  metric: "4",
  metricLabel: "active goals",
  metricCaption: "Each goal connects status, evidence, barriers, and between-session actions.",
  searchPlaceholder: "Search values, skills, or progress",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients and therapists checking movement across agreed therapy goals need before they commit, then keeps the next action obvious and low-pressure.",
  ...
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for a client progress and goals tracker.",
    "metric": "4",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after update progress, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "values",
    "detail": "Visitors can understand a client progress and goals tracker without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "skills",
  ...
  },
  {
    "label": "Begin care",
    "value": "4",
    "detail": "Each goal connects status, evidence, barriers, and between-session actions."
  }
];
const RESOURCES = [
  "Care Delivery guide",
...
export default function ClientGoalsTracker() {
