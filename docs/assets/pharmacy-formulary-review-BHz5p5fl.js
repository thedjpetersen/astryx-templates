...
/**
 * @file page.tsx
 * @input Deterministic Dosewise fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Pharmacy Formulary Review: Committee review board for formulary requests with therapeutic class coverage, substitutions, and vote readiness.
...
const BRAND = "Dosewise";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Pharmacy priority packet",
    "owner": "Mina Park",
    "state": "risk",
    "progress": 60,
    "metric": "7 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final formulary check before the handoff can leave review.",
    "points": [
      22,
      38,
      31,
  ...
  {
    "id": "item-02",
    "title": "Dosewise exception sweep",
    "owner": "Sam Rivera",
    "state": "review",
    "progress": 71,
    "metric": "12 queued",
  ...
  {
    "id": "item-03",
    "title": "Formulary readiness lane",
    "owner": "June Kim",
    "state": "ready",
    "progress": 87,
    "metric": "75% ready",
  ...
  {
    "id": "item-04",
    "title": "Dosewise owner follow-up",
    "owner": "Maya Fox",
    "state": "review",
    "progress": 64,
    "metric": "2 handoffs",
  ...
  {
    "id": "item-05",
    "title": "Pharmacy signed-off path",
    "owner": "Nia Flores",
    "state": "ready",
    "progress": 95,
    "metric": "16 artifacts",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Pharmacy Formulary Review</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Pharmacy Formulary Review command rail">
          ...
          <section className="panel" aria-label="Pharmacy Formulary Review queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Pharmacy Formulary Review detail inspector">
            <div className="panelHeader">
