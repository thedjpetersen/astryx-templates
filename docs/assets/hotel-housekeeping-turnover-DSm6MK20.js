...
/**
 * @file page.tsx
 * @input Deterministic Roomturn fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Housekeeping Turnover Board: Hotel turnover board for room readiness, inspection exceptions, VIP holds, and late checkout conflicts.
...
const SCOPE = "tpl-hotel-housekeeping-turnover";
const BRAND = "Roomturn";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Housekeeping priority packet",
    "owner": "Theo Grant",
    "state": "risk",
    "progress": 78,
    "metric": "6 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final turnover check before the handoff can leave review.",
    "points": [
      22,
      35,
      31,
  ...
  {
    "id": "item-02",
    "title": "Roomturn exception sweep",
    "owner": "Ana Ito",
    "state": "review",
    "progress": 89,
    "metric": "9 queued",
  ...
  {
    "id": "item-04",
    "title": "Roomturn owner follow-up",
    "owner": "Eli Stone",
    "state": "risk",
    "progress": 82,
    "metric": "5 handoffs",
  ...
  {
    "id": "item-05",
    "title": "Housekeeping signed-off path",
    "owner": "Jon Bell",
    "state": "ready",
    "progress": 100,
    "metric": "19 artifacts",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Housekeeping Turnover Board</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Housekeeping Turnover Board command rail">
          ...
          <section className="panel" aria-label="Housekeeping Turnover Board queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Housekeeping Turnover Board detail inspector">
            <div className="panelHeader">
