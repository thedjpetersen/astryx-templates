...
/**
 * @file page.tsx
 * @input Deterministic Recoup fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Claims Recovery Ledger: Subrogation and overpayment recovery ledger with case aging, expected yield, evidence packets, and payer touchpoints.
...
const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Claims priority packet",
    "owner": "Owen Ellis",
    "state": "risk",
    "progress": 63,
    "metric": "3 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final recovery check before the handoff can leave review.",
    "points": [
      22,
      39,
      31,
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Claims Recovery Ledger command rail">
          ...
          <section className="panel" aria-label="Claims Recovery Ledger queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Claims Recovery Ledger detail inspector">
            <div className="panelHeader">
