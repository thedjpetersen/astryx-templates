...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Consult Call Scheduler. No Date.now(),
 ...
 * @output Consult Call Scheduler: Therapy website experience for a free consultation call scheduler, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients who want a short conversation before choosing a therapist. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template therapy-consult-call-scheduler\`
 *
...
const SCOPE = "tpl-therapy-consult-call-scheduler";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Scheduling",
  title: "Consult Call Scheduler",
  focus: "a free consultation call scheduler",
  audience: "clients who want a short conversation before choosing a therapist",
  primary: "Schedule consult",
  secondary: "Send message",
  metric: "15 min",
  metricLabel: "intro call",
  metricCaption: "Consult expectations, agenda, and therapist response windows are explicit.",
  searchPlaceholder: "Search phone, video, or no charge",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients who want a short conversation before choosing a therapist need before they commit, then keeps the next action obvious and low-pressure.",
    "metric": "Schedule consult",
    "icon": "search",
    "tone": "mint"
  },
  {
    "title": "Find a trusted fit",
    "detail": "Highlights license, specialty, modality, availability, and payment context for a free consultation call scheduler.",
    "metric": "15 min",
    "icon": "shield",
    "tone": "blue"
  },
  {
    ...
    "detail": "Shows exactly what happens after schedule consult, from confirmation to secure prep materials.",
    "metric": "4 steps",
    "icon": "calendar",
    "tone": "violet"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "phone",
    "detail": "Visitors can understand a free consultation call scheduler without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "video",
  ...
  },
  {
    "label": "Begin care",
    "value": "15 min",
    "detail": "Consult expectations, agenda, and therapist response windows are explicit."
  }
];
const RESOURCES = [
  "Scheduling guide",
...
export default function TherapyConsultCallScheduler() {
