...
/**
 * @file page.tsx
 * @input Deterministic Gatherpost fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Volunteer Roster: Community event roster for volunteer roles, arrival waves, training status, and gap-filling actions.
 * @position Page template; emitted by \`astryx template community-event-volunteer-roster\`
 *
...
const BRAND = "Gatherpost";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Volunteer priority packet",
    "owner": "Mina Park",
    "state": "risk",
    "progress": 60,
    "metric": "6 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final civic check before the handoff can leave review.",
    "points": [
      22,
      40,
      31,
  ...
  {
    "id": "item-02",
    "title": "Gatherpost exception sweep",
    "owner": "Sam Rivera",
    "state": "review",
    "progress": 71,
    "metric": "8 queued",
  ...
  {
    "id": "item-04",
    "title": "Gatherpost owner follow-up",
    "owner": "Maya Fox",
    "state": "review",
    "progress": 64,
    "metric": "2 handoffs",
  ...
  {
    "id": "item-05",
    "title": "Volunteer signed-off path",
    "owner": "Nia Flores",
    "state": "ready",
    "progress": 95,
    "metric": "15 artifacts",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              <p className="eyebrow">{BRAND} / Civic</p>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Volunteer Roster command rail">
          ...
          <section className="panel" aria-label="Volunteer Roster queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Volunteer Roster detail inspector">
            <div className="panelHeader">
