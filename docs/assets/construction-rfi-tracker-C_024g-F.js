...
/**
 * @file page.tsx
 * @input Deterministic Fieldnote fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Construction RFI Tracker: Jobsite RFI tracker with drawing references, cost exposure, trade owners, and answer aging.
...
const BRAND = "Fieldnote";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Construction priority packet",
    "owner": "Owen Ellis",
    "state": "risk",
    "progress": 69,
    "metric": "7 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final rfi check before the handoff can leave review.",
    "points": [
      22,
      35,
      31,
  ...
  {
    "id": "item-02",
    "title": "Fieldnote exception sweep",
    "owner": "Leah Chen",
    "state": "review",
    "progress": 80,
    "metric": "13 queued",
  ...
  {
    "id": "item-04",
    "title": "Fieldnote owner follow-up",
    "owner": "Drew Patel",
    "state": "risk",
    "progress": 73,
    "metric": "3 handoffs",
  ...
  {
    "id": "item-05",
    "title": "Construction signed-off path",
    "owner": "Marcus Lee",
    "state": "ready",
    "progress": 100,
    "metric": "14 artifacts",
    ...
    <Layout height="fill">
        ...
        <div className={SCOPE + ' topbar'}>
          <div className="titleCluster">
            ...
            <div style={{minWidth: 0} as CSSProperties}>
              ...
              <h1>Construction RFI Tracker</h1>
            </div>
          </div>
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Construction RFI Tracker command rail">
          ...
          <section className="panel" aria-label="Construction RFI Tracker queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Construction RFI Tracker detail inspector">
            <div className="panelHeader">
