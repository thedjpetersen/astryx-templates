...
/**
 * @file page.tsx
 * @input Deterministic therapy-site fixture for Privacy Consent Center. No Date.now(),
 ...
 * @output Privacy Consent Center: Therapy website experience for a privacy and consent center, including discovery, trust cues, care logistics, privacy guidance, and clear next-step actions for clients reviewing therapy privacy, data sharing, and communication consent. The primary and secondary CTAs
 ...
 * @position Page template; emitted by \`astryx template privacy-consent-center\`
 *
...
const SCOPE = "tpl-privacy-consent-center";
const PAGE = {
  brand: 'KindPath Therapy',
  eyebrow: "Trust",
  title: "Privacy Consent Center",
  focus: "a privacy and consent center",
  audience: "clients reviewing therapy privacy, data sharing, and communication consent",
  primary: "Review consent",
  secondary: "Manage choices",
  metric: "100%",
  metricLabel: "required choices",
  metricCaption: "Consent modules separate clinical privacy, billing, messages, and releases.",
  searchPlaceholder: "Search privacy, HIPAA, or consent",
} as const;
...
const FEATURES: FeatureCard[] = [
  {
    ...
    "detail": "Captures what clients reviewing therapy privacy, data sharing, and communication consent need before they commit, then keeps the next action obvious and low-pressure.",
  ...
  },
  {
    ...
    "detail": "Highlights license, specialty, modality, availability, and payment context for a privacy and consent center.",
    "metric": "100%",
    "icon": "shield",
    "tone": "blue"
  },
...
const STEPS: PathStep[] = [
  {
    "label": "Explore",
    "value": "privacy",
    "detail": "Visitors can understand a privacy and consent center without reading dense clinical copy."
  },
  {
    "label": "Check fit",
    "value": "HIPAA",
  ...
  },
  {
    "label": "Begin care",
    "value": "100%",
    "detail": "Consent modules separate clinical privacy, billing, messages, and releases."
  }
];
const RESOURCES = [
  "Trust guide",
