...
/**
 * @file page.tsx
 * @input Deterministic Partnerway fixtures only: five work items, four stage
 *   counters, fixed due labels, and six-point trend arrays. No Date.now(),
 *   no Math.random(), no timers, and no network assets.
 * @output Partner Onboarding Portal: Partner activation workspace for credentials, sandbox tests, enablement tasks, and launch blockers.
...
const BRAND = "Partnerway";

const INITIAL_ITEMS: WorkItem[] = [
  {
    "id": "item-01",
    "title": "Partner priority packet",
    "owner": "Owen Ellis",
    "state": "risk",
    "progress": 60,
    "metric": "5 blockers",
    "due": "Today 2:00 PM",
    "detail": "Needs owner confirmation, evidence refresh, and a final onboarding check before the handoff can leave review.",
    "points": [
      22,
      36,
      31,
  ...
  {
    "id": "item-02",
    "title": "Partnerway exception sweep",
    "owner": "Leah Chen",
    "state": "review",
    "progress": 71,
    "metric": "9 queued",
  ...
  {
    "id": "item-03",
    "title": "Onboarding readiness lane",
    "owner": "Iris Cole",
    "state": "ready",
    "progress": 87,
    "metric": "74% ready",
  ...
  {
    "id": "item-04",
    "title": "Partnerway owner follow-up",
    "owner": "Drew Patel",
    "state": "risk",
    "progress": 64,
    "metric": "3 handoffs",
    ...
    <Layout height="fill">
      ...
      <LayoutContent>
        <div className={SCOPE + ' workspace'}>
          <section className="panel" aria-label="Partner Onboarding Portal command rail">
          ...
          <section className="panel" aria-label="Partner Onboarding Portal queue">
            <div className="panelHeader">
          ...
          <aside className="panel detailPanel" aria-label="Partner Onboarding Portal detail inspector">
            <div className="panelHeader">
